    ...
    BayarNontunai: function BayarNontunai() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default().post('api/bookings/nontunai', {
        ...
        if (data.code === 200 && data.data.virtual_account_info.how_to_pay_api) {
          var howToPayApi = JSON.stringify(data.data.virtual_account_info.how_to_pay_api);
          console.log(howToPayApi); // console.log(data.data.virtual_account_info.how_to_pay_api)
        } else {
