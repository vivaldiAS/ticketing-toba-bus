  ...
  methods: {
    ...
    submitData: function submitData() {
      ...
      if (!isNaN(this.totalHarga) && this.totalHarga !== null) {
        ...
        this.$store.commit('SET_SELECTED_SEATS', this.selectedChairs);
      } else {
      ...
      this.proceedToConfirmation(); // Jika Anda ingin langsung melanjutkan ke halaman konfirmasi setelah submit
    },
    ...
    proceedToConfirmation: function proceedToConfirmation() {
      if (this.selectedChairs.length > 0) {
        // Menggunakan router.push untuk navigasi dengan query parameters
        this.$router.push({
          path: '/confirmasi-pemesanan',
          query: {
            totalHarga: this.totalHarga,
            selectedChairs: JSON.stringify(this.selectedChairs)
          }
        });
      } else {
