...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])((0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({
    toRupiah: function toRupiah(value, selectedSeatsCount) {
      var totalPrice = value * selectedSeatsCount;
      var formatter = new Intl.NumberFormat("id-ID", {
        style: "currency",
        currency: "IDR",
        minimumFractionDigits: 0
    ...
    toggleChairSelection: function toggleChairSelection(chair) {
      var index = this.selectedChairs.indexOf(chair);

      if (index === -1) {
        // If chair is not already selected, add it
        this.selectedChairs.push(chair);
      } else {
        // If chair is already selected, remove it
    ...
    getbookingsChair: function getbookingsChair() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_6___default().get("/api/bookings/show/schedules/".concat(this.id_schedule), {
        headers: {
    ...
    getSchedule: function getSchedule() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_6___default().get(uri, {
        headers: {
          Authorization: "Bearer ".concat(access_token)
        }
      }).then(function (response) {
    ...
    selectedChairs: function selectedChairs(newValue) {
      ...
      newValue.forEach(function (seat) {
        if (_this3.bookingsChair.some(function (chair) {
          ...
          _this3.snackbar.message = "Kursi telah dipilih orang lain";
          _this3.snackbar.show = true;

          _this3.selectedChairs.splice(_this3.selectedChairs.indexOf(seat), 1);
        }
      });
    }
  }
                        ...
                        _c(
                          ...
                          [
                            _c(
                              "v-card",
                              { staticClass: "mb-3" },
                              _vm._l(_vm.selectedChairs, function (seat) {
                                return _c(
                                  "v-row",
                                  { key: seat },
                                  [
