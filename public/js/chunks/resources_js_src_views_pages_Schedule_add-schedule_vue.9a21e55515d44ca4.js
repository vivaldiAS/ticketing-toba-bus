  ...
  methods: {
    saveSelectBus: function saveSelectBus() {
      ...
      if (selectedBus) {
        ...
        var selectedBusLocation = selectedBus.lokasi_loket; // Jika bus memiliki lokasi loket, filter rute berdasarkan lokasi loket
        ...
        if (selectedBusLocation) {
          ...
          // Jika bus tidak memiliki lokasi loket, tampilkan semua rute
          // Reset array rute dengan data awal
          this.route = this.initialRouteData;
        }
      }
    },
