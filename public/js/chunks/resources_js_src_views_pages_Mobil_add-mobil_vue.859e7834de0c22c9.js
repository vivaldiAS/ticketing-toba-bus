...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    var police_number = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__.ref)("");
    var num_seats = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__.ref)("");
    var type = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__.ref)();
    var status = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__.ref)();
    var driver = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__.ref)();
    return {
      ...
      status: status,
      driver: driver,
      mobil: ["police_number", "type", "driver", "number_of_seats", "nomor_pintu", "merk", "status"]
    };
  },
  data: function data() {
    return {
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_2___default().get("/api/supir/name/all", {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
      _this.supir = response.data.map(function (item) {
        return {
          name: item.name,
          id: item.id
        };
  ...
  methods: {
    AddMobil: function AddMobil() {
      ...
      var access_token = localStorage.getItem("access_token");
      axios__WEBPACK_IMPORTED_MODULE_2___default().post("/api/buss/add", {
                  ...
                  _c(
                    ...
                    [
                      _c("v-select", {
                        ...
                        model: {
                          value: _vm.mobil.status,
                          callback: function ($$v) {
                            _vm.$set(_vm.mobil, "status", $$v)
                          },
                          expression: "mobil.status",
                        },
                      }),
                    ],
                    1
