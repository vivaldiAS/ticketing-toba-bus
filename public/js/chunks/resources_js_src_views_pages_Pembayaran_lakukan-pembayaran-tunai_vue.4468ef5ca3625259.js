  ...
  methods: {
    ...
    getPaymentData: function getPaymentData(paymentId) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().get(uri, {
        ...
        _this2.expiredDate = paymentData.expired_date;
      })["catch"](function (error) {
    ...
    startCountdown: function startCountdown() {
      ...
      if (this.schedule.length > 0) {
        ...
        var expiredTime = moment__WEBPACK_IMPORTED_MODULE_3___default()(this.expiredDate, "YYYY-MM-DD HH:mm:ss"); // Tambahkan format tanggal di sini
        // Tentukan waktu maksimum countdown

        var maxCountdownTime = moment__WEBPACK_IMPORTED_MODULE_3___default().min(departureTime.subtract(1, "hours"), expiredTime);
