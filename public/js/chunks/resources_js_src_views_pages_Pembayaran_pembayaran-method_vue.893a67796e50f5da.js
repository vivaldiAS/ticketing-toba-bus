...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      icons: {
        ...
        mdiCreditCard: _mdi_js__WEBPACK_IMPORTED_MODULE_8__.mdiCreditCard,
        mdiCashCheck: _mdi_js__WEBPACK_IMPORTED_MODULE_8__.mdiCashCheck,
        mdiWalletOutline: _mdi_js__WEBPACK_IMPORTED_MODULE_8__.mdiWalletOutline
      },
      bookings: ['schedules_id', 'name', 'age', 'num_seats', 'alamat_jemput', 'status', 'harga']
    };
  },
  computed: (0,D_Other_LARAVUE_APP_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])((0,D_Other_LARAVUE_APP_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({}, (0,vuex__WEBPACK_IMPORTED_MODULE_9__.mapState)(['selectedSeat'])), {}, {
  ...
  methods: {
    ...
    formatHour: function formatHour(date) {
      moment__WEBPACK_IMPORTED_MODULE_5___default().locale('id');
      return moment__WEBPACK_IMPORTED_MODULE_5___default()(date).format('hh:mm');
    },
    ...
    BayarCash: function BayarCash() {
      ...
      var access_token = localStorage.getItem('access_token');
      axios__WEBPACK_IMPORTED_MODULE_4___default().post('api/bookings', {
    ...
    BayarNontunai: function BayarNontunai() {
      var access_token = localStorage.getItem('access_token');
      axios__WEBPACK_IMPORTED_MODULE_4___default().post('api/bookings/nontunai', {
        schedules_id: this.id_schedule,
        name: this.passengerData.name,
        age: this.passengerData.age,
        num_seats: this.selectedSeat,
        ...
        if (data.code === 200 && data.data.virtual_account_info.how_to_pay_api) {
          var xmlString = data.data.virtual_account_info.how_to_pay_api;
          var xml = xmlString.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
...
var render = function () {
  ...
  return _c(
    "div",
    [
      _c("h3", { attrs: { "pa-3": "", "ma-3": "" } }, [_vm._v("Pembayaran")]),
      _vm._v(" "),
                          ...
                          [
                            _c(
                              ...
                              [
                                ...
                                _vm._v(" "),
                                _c("h6", [
                                  _vm._v(_vm._s(_vm.passengerData.age)),
                                ]),
                              ]
                            ),
                          ],
