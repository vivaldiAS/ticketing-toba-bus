...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_7___default().get("/api/buss/show/noJadwal", {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
  ...
  methods: {
    saveSelectBus: function saveSelectBus() {
      ...
      if (selectedBus) {
        ...
        // Simpan data rute asli sebelum difilter

        var originalRoute = this.route.slice(); // Filter rute berdasarkan lokasi loket dari bus yang dipilih

        this.route = originalRoute.filter(function (route) {
    ...
    AddSchedule: function AddSchedule() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_7___default().post("/api/schedule/add", // Ensure correct URL with leading slash
      {
