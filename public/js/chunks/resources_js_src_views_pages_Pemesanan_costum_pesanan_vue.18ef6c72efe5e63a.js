...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    return {
      icons: {
        ...
        mdiSofaSingleOutline: _mdi_js__WEBPACK_IMPORTED_MODULE_10__.mdiSofaSingleOutline,
        mdiSofaSingle: _mdi_js__WEBPACK_IMPORTED_MODULE_10__.mdiSofaSingle,
        mdiChevronRight: _mdi_js__WEBPACK_IMPORTED_MODULE_10__.mdiChevronRight,
        mdiSteering: _mdi_js__WEBPACK_IMPORTED_MODULE_10__.mdiSteering
      }
    };
  },
  data: function data() {
  ...
  computed: (0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])((0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({}, (0,vuex__WEBPACK_IMPORTED_MODULE_11__.mapState)(["busData", "selectedSeat"])), {}, {
  ...
  methods: (0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])((0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({
    ...
    getTotalPrice: function getTotalPrice(basePrice) {
      return basePrice * this.selectedChair.length;
    },
  ...
  }, (0,vuex__WEBPACK_IMPORTED_MODULE_11__.mapActions)(["setSelectedSeat"])), {}, {
    selectSeat: function selectSeat(seat) {
      // Temukan indeks kursi yang dipilih di dalam array selectedChair
      var index = this.selectedChair.indexOf(seat); // Jika kursi sudah dipilih, hapus dari array

      if (index !== -1) {
        this.selectedChair.splice(index, 1);
      } else {
        // Jika kursi belum dipilih, tambahkan ke dalam array
        this.selectedChair.push(seat);
      }
    },
    getbookingsChair: function getbookingsChair() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_7___default().get("/api/bookings/show/schedules/".concat(this.id_schedule), {
        headers: {
    ...
    getSchedule: function getSchedule() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_7___default().get(uri, {
        headers: {
          Authorization: "Bearer ".concat(access_token)
        }
      }).then(function (response) {
    ...
    bookSeats: function bookSeats(seats) {
      // Lakukan apa yang perlu dilakukan saat tombol 'Book' ditekan
      console.log("Booking seats:", seats);
      var totalPrice = this.getTotalPrice(item.harga);
      console.log("Seats booked:", seats);
      console.log("Total Price:", totalPrice); // Anda dapat menambahkan logika untuk proses pemesanan di sini, misalnya mengirim data pemesanan ke server
    }
  }),
  watch: {
    ...
    selectedChair: function selectedChair(newValue) {
      ...
      newValue.forEach(function (seat) {
        // Jika seat lebih besar dari 3, kurangi satu
        var adjustedSeat = seat > 3 ? seat - 1 : seat;

        if (_this3.bookingsChair.some(function (chair) {
          return chair.num_seats === adjustedSeat;
        })) {
          _this3.snackbar.message = "Kursi ".concat(seat, " telah dipilih orang lain");
          _this3.snackbar.show = true; // Hapus kursi dari array selectedChair

          _this3.selectedChair = _this3.selectedChair.filter(function (chair) {
            return chair !== seat;
          });
        }
      });
