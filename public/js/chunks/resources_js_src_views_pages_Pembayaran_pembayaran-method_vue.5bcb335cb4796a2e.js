...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      bookings: ['schedules_id', 'name', 'number_phone ', 'num_seats', 'alamat_jemput', 'status', 'harga']
    };
  },
    ...
    BayarNontunai: function BayarNontunai() {
      ...
      try {
        axios__WEBPACK_IMPORTED_MODULE_2___default().post('api/bookings/nontunai', {
          ...
          _this4.loading = true; // hidupkan animasi loading

          var data = response.data; // window.open(data.data.virtual_account_info.how_to_pay_page, '_blank')
          // this.loading = false;
