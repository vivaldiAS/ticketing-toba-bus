...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchSchedules: function fetchSchedules() {
      ...
      this.access_token = localStorage.getItem('access_token'); // Simpan access_token ke dalam variabel data

      axios__WEBPACK_IMPORTED_MODULE_3___default().get('/api/default-schedules', {
        headers: {
          Authorization: "Bearer ".concat(this.access_token) // Gunakan this.access_token
  ...
  mounted: function mounted() {
    this.fetchSchedules();
    console.log("AKSES TOKEN: ", this.access_token); // Gunakan this.access_token untuk mengakses variabel data
  }
});
