...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (0,E_laragon_www_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])((0,E_laragon_www_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({
    getBrands: function getBrands() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().get("/api/allBrands").then(function (response) {
        _this.brandOptions = response.data;
      })["catch"](function (error) {
        console.log(error);
      });
    }
  }, (0,vuex__WEBPACK_IMPORTED_MODULE_6__.mapActions)(["setSelectedSeat"])), {}, {
    ...
    formatDate: function formatDate(date) {
      ...
      return moment__WEBPACK_IMPORTED_MODULE_3___default()(date).format("dddd, Do MMMM YYYY, hh:mm:ss");
    },
    getSchedule: function getSchedule() {
      ...
      this.getSchedule();
      axios__WEBPACK_IMPORTED_MODULE_2___default().get("api/routes", {
        headers: {
