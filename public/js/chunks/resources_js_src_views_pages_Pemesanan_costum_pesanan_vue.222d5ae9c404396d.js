  ...
  setup: function setup() {
    return {
      icons: {
        ...
        mdiSofaSingleOutline: _mdi_js__WEBPACK_IMPORTED_MODULE_6__.mdiSofaSingleOutline,
        mdiSofaSingle: _mdi_js__WEBPACK_IMPORTED_MODULE_6__.mdiSofaSingle,
        mdiChevronRight: _mdi_js__WEBPACK_IMPORTED_MODULE_6__.mdiChevronRight,
        mdiSteering: _mdi_js__WEBPACK_IMPORTED_MODULE_6__.mdiSteering
      }
    };
  },
  data: function data() {
  ...
  methods: {
    submitData: function submitData() {
      ...
      if (!isNaN(this.totalHarga) && this.totalHarga !== null) {
        ...
        console.log('selectedSeatPrice:', this.selectedSeatPrice); // Tambahkan log ini untuk memastikan nilai selectedSeatPrice yang diset
      } else {
    ...
    getbookingsChair: function getbookingsChair() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default().get("/api/bookings/show/schedules/".concat(this.id_schedule), {
        headers: {
