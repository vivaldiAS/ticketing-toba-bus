...
/* harmony import */ var vue_otp_2__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! vue-otp-2 */ "./node_modules/vue-otp-2/dist/vue-otp-2.esm.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    VueOtp2: vue_otp_2__WEBPACK_IMPORTED_MODULE_6__["default"]
  },
  setup: function setup() {
    var email = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_7__.ref)("");
    var otpCode = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_7__.ref)("");
    return {
      email: email,
      otpCode: otpCode,
      isOTP: false,
  ...
  methods: {
    submitEmail: function submitEmail() {
      ...
      this.isLoading = true;
      axios__WEBPACK_IMPORTED_MODULE_4___default().post("api/reset-password", {
        email: this.email
    ...
    startCountdown: function startCountdown() {
      ...
      this.timer = setInterval(function () {
        ...
        _this2.countdown = "".concat(minutes.toString().padStart(2, "0"), ":").concat(seconds.toString().padStart(2, "0"));
        remainingSeconds--;
