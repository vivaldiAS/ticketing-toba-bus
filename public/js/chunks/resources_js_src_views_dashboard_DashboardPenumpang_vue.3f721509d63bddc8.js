...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])((0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({
    ...
    filterSchedules: function filterSchedules() {
      ...
      filteredSchedules = filteredSchedules.filter(function (schedule) {
        return moment__WEBPACK_IMPORTED_MODULE_8___default()(schedule.tanggal).isSameOrAfter(moment__WEBPACK_IMPORTED_MODULE_8___default()(), "day");
      });
  ...
  mounted: function mounted() {
    ...
    var access_token = localStorage.getItem("access_token");
    this.getSchedule();
    axios__WEBPACK_IMPORTED_MODULE_7___default().get("api/routes/show/all", {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
