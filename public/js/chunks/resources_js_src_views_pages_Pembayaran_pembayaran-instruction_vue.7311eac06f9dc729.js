...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      icons: {
        mdiCheckCircleOutline: _mdi_js__WEBPACK_IMPORTED_MODULE_1__.mdiCheckCircleOutline
      },
      paymentInstructions: []
    };
  },
  mounted: function mounted() {
    ...
    this.fetchPaymentStatus(); // Start a timer to fetch the updated status every 10 seconds (adjust the interval as needed)

    this.statusUpdateTimer = setInterval(function () {
      _this.fetchPaymentStatus();
    }, 30000);
  },
  methods: {
    ...
    fetchPaymentStatus: function fetchPaymentStatus() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get(url, {
        ...
        _this2.paymentInstructions = response.data;
...
/***/ "./resources/js/src/assets/images/check.gif":
/*!**************************************************!*\
  !*** ./resources/js/src/assets/images/check.gif ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("/images/check.gif?f486f275b96f798167472799d1e1bc46");
  ...
  return _c(
    ...
    [
              ...
              _c("div", { staticClass: "payment-details" }, [
                ...
                _c("p", [
                  ...
                  _vm._v(
                    " " +
                      _vm._s(
                        _vm.paymentInstructions.virtual_account_info.status
                      ) +
                      "\n      "
                  ),
                ]),
      ...
      _vm.paymentInstructions.virtual_account_info.status == "PAID"
        ? _c("v-card", { staticClass: "payment-success-card" }, [
            _c("div", { staticClass: "checklist-icon-container" }, [
              _c("img", {
                attrs: {
                  src: (__webpack_require__(/*! @/assets/images/check.gif */ "./resources/js/src/assets/images/check.gif")["default"]),
                  width: "100px",
                  alt: "avatar",
                },
              }),
            ...
            _vm._v(" "),
            _c("div", { staticClass: "payment-success-content" }, [
              _c("h3", { staticStyle: { color: "#76ae46" } }, [
                _vm._v("Berhasil"),
              ]),
              _vm._v(" "),
              _c("p", [
              ...
              _c("p", [
                _c("strong", [_vm._v("Amount:")]),
                _vm._v(" Rp." + _vm._s(_vm.paymentInstructions.order.amount)),
              ]),
              _vm._v(" "),
              _c("p", [
                _c("strong", [_vm._v("No. Virtual Account:")]),
                _vm._v(
                  "\n        " +
                    _vm._s(
                      _vm.paymentInstructions.virtual_account_info
              ...
              _c("p", [
                ...
                _vm._v(
                  " " +
                    _vm._s(
                      _vm.paymentInstructions.virtual_account_info.created_date
                    ) +
                    "\n      "
                ),
              ]),
              ...
              _c("p", [
                ...
                _vm._v(" " + _vm._s(_vm.paymentInstructions.customer.name)),
              ]),
            ]),
          ])
        : _vm._e(),
