    ...
    BayarNontunai: function BayarNontunai() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().post('api/bookings/nontunai', {
        ...
        if (data.code === 200 && data.data.virtual_account_info.how_to_pay_api) {
          var howToPayApi = data.data.virtual_account_info.how_to_pay_api; // console.log(howtoPayStep);
          // console.log(data.data.virtual_account_info.how_to_pay_api)

          _this4.$router.push("/pembayaran-method");
        } else {
