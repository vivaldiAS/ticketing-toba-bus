...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    var schedule = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_5__.ref)({
      bus_id: "",
      route_id: "",
      tanggal: "",
      harga: ""
    });
    var bus = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_5__.ref)([]);
    var route = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_5__.ref)([]);
    return {
      schedule: schedule,
      bus: bus,
      route: route,
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_4___default().get("/api/schedule/show/".concat(id), {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
