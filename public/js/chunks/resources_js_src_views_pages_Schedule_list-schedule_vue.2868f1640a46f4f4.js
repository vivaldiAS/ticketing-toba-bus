...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    formatDate: function formatDate(date) {
      return moment__WEBPACK_IMPORTED_MODULE_6___default()(date).format("dddd, DD MMMM YYYY, HH:mm:ss");
    },
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_5___default().get("/api/schedule/admin/show/all", {
      headers: {
      ...
      schedules.forEach(function (schedule) {
        // current date
        var currentDate = new Date(); // add 1 day

        var scheduleDate = new Date(schedule.tanggal);
        scheduleDate.setHours(scheduleDate.getHours() + 24); // update format

        var scheduledateUp = formatDateToYMDHIS(scheduleDate);
        var scheduledateUpObj = new Date(scheduledateUp);

        if (scheduledateUpObj < currentDate) {
          schedule.status = "complete";
          axios__WEBPACK_IMPORTED_MODULE_5___default().put("/api/status/update/auto/".concat(schedule.schedule_id), {
            status: "complete"
          }, {
            headers: {
              Authorization: "Bearer ".concat(access_token)
            ...
            console.log("Schedule with id=".concat(schedule.schedule_id, " marked as complete"));
        ...
        schedule.tanggal = _this.formatDate(schedule.tanggal);
