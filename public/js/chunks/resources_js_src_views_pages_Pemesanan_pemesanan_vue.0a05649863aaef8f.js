...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])((0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({}, (0,vuex__WEBPACK_IMPORTED_MODULE_13__.mapActions)(["setSelectedSeat"])), {}, {
    ...
    formatDate: function formatDate(date) {
      moment__WEBPACK_IMPORTED_MODULE_10___default().locale("id");
      return moment__WEBPACK_IMPORTED_MODULE_10___default()(date).format("dddd, Do MMMM YYYY, hh:mm");
    },
    ...
    filterSchedules: function filterSchedules() {
      ...
      if (this.selectedDate) {
        filteredSchedules = filteredSchedules.filter(function (schedule) {
          return moment__WEBPACK_IMPORTED_MODULE_10___default()(schedule.tanggal).format("YYYY-MM-DD") === moment__WEBPACK_IMPORTED_MODULE_10___default()(_this.selectedDate).format("YYYY-MM-DD");
        });
      }
  ...
  mounted: function mounted() {
    ...
    var access_token = localStorage.getItem("access_token");
    this.getSchedule();
    axios__WEBPACK_IMPORTED_MODULE_9___default().get("api/routes/show/all", {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
