...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    var mobil = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__.ref)({
      "police_number": "",
      "type": "",
      "driver": "",
      "number_of_seats": "",
    ...
    var supir = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__.ref)([]);
    var loket = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__.ref)([]);
    return {
      supir: supir,
      loket: loket,
      mobil: mobil
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_3___default().get("/api/supir/name/all", {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
      _this.supir = Object.values(response.data).map(function (item) {
        return {
          name: item.name,
          id: item.id
        };
    ...
    axios__WEBPACK_IMPORTED_MODULE_3___default().get("/api/buss/show/all", {
      ...
      _this.bus = Object.values(response.data).map(function (item) {
        return {
          name: item.name,
          id: item.id
        };
    ...
    axios__WEBPACK_IMPORTED_MODULE_3___default().get("/api/loket/all", {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
      _this.loket = Object.values(response.data).map(function (item) {
        return {
    ...
    axios__WEBPACK_IMPORTED_MODULE_3___default().get("/api/bus/get/".concat(id), {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
      _this.mobil = response.data.data[0]; // console.log(this.mobil);
    })["catch"](function (error) {
      console.log(error);
    });
  },
  methods: {
    UpdateMobil: function UpdateMobil() {
      ...
      var id = this.$route.params.id;
      axios__WEBPACK_IMPORTED_MODULE_3___default().put("/api/buss/update/".concat(id), {
                  ...
                  _c(
                    ...
                    [
                      _c("v-select", {
                        ...
                        model: {
                          value: _vm.mobil.supir,
                          callback: function ($$v) {
                            _vm.$set(_vm.mobil, "supir", $$v)
                          },
                          expression: "mobil.supir",
                        },
                      }),
                    ],
                    1
