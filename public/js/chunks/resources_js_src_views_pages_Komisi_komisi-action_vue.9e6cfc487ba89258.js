...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().get('/api/komisi', {
      headers: {
              ...
              return [
                _c("thead", [
                  _c("tr", [
                    ...
                    _vm._v(" "),
                    _c("th", [_vm._v("Brand ID")]),
                  ]),
                ]),
                _vm._v(" "),
                _c("tbody", [
                  _c("tr", [
                    _c("td", [_vm._v(_vm._s(_vm.persentaseKomisi) + "%")]),
                    _vm._v(" "),
                    _c("td", [
                      _vm._v(_vm._s(_vm._f("toRupiah")(_vm.setoranKantor))),
                    ]),
                    _vm._v(" "),
                    _c("td", [
                      _vm._v(_vm._s(_vm._f("toRupiah")(_vm.administrasi))),
                    ]),
                    _vm._v(" "),
                    _c("td", [_vm._v(_vm._s(_vm.brandId))]),
                  ]),
                ]),
              ]
            },
