...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    saveSelectBus: function saveSelectBus() {
      ...
      if (selectedBus) {
        // Simpan lokasi loket dari bus yang dipilih
        var selectedBusLokasiLoket = selectedBus.lokasi_loket;
        ...
        // Filter rute berdasarkan lokasi loket dari bus

        this.route = this.route.filter(function (route) {
          return route.derpature.includes(selectedBusLokasiLoket) || route.arrival.includes(selectedBusLokasiLoket);
        });
      }
    },
