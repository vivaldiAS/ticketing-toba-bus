    ...
    getBookingsChair: function getBookingsChair() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_8___default().get("/api/bookings/show/schedules/".concat(this.id_schedule), {
        ...
        if (response.data && Array.isArray(response.data)) {
          // Pastikan response.data bukan null atau undefined
          _this.bookingsChair = response.data.reduce(function (acc, item) {
            return acc.concat(item.seat_numbers);
          }, []);
        } else {
          // Tangani jika data kosong atau tidak valid
          console.error("Data response tidak valid atau kosong");
          _this.bookingsChair = []; // Atur bookingsChair ke array kosong
        }
