...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_4___default().get("/api/bookings/my", {
      ...
      }); // Memeriksa dan mengubah status pembayaran jika expired_date sudah lewat
      ...
      _this.pesanan.forEach(function (item) {
        ...
        if (now > expiredDate && item.status_pay !== "Expired") {
          item.status_pay = "Expired"; // Mengirim permintaan ke API untuk memperbarui status pembayaran
