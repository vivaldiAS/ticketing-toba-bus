...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: (0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])((0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({}, (0,vuex__WEBPACK_IMPORTED_MODULE_12__.mapState)(["busData"])), {}, {
  ...
  methods: {
    ...
    submitData: function submitData() {
      ...
      if (!isNaN(this.totalHarga) && this.totalHarga !== null) {
        console.log('Nilai selectedSeat sebelum komitasi:', this.selectedSeat); // Komitasi nilai selectedSeat ke Vuex

        this.$store.commit('SET_SELECTED_SEATS', this.selectedSeat.slice());
        console.log('Nilai selectedSeat setelah komitasi:', this.selectedSeat);
        this.proceedToConfirmation(); // Navigasi ke halaman konfirmasi pemesanan
      } else {
