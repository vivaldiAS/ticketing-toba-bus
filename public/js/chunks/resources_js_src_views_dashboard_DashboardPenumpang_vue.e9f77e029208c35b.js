...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    return {
      icons: {
        ...
        mdiHelpCircle: _mdi_js__WEBPACK_IMPORTED_MODULE_9__.mdiHelpCircle
      }
    };
  },
  data: function data() {
  ...
  methods: (0,E_laragon_www_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])((0,E_laragon_www_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({
    getBrands: function getBrands() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_6___default().get("/api/allBrands").then(function (response) {
    ...
    filterSchedules: function filterSchedules() {
      ...
      filteredSchedules = filteredSchedules.filter(function (schedule) {
        return moment__WEBPACK_IMPORTED_MODULE_7___default()(schedule.tanggal).isSameOrAfter(moment__WEBPACK_IMPORTED_MODULE_7___default()(), 'day') && moment__WEBPACK_IMPORTED_MODULE_7___default()(schedule.tanggal).isSameOrAfter(moment__WEBPACK_IMPORTED_MODULE_7___default()(), 'hour');
      });

      if (this.selectedDate) {
        filteredSchedules = filteredSchedules.filter(function (schedule) {
          return moment__WEBPACK_IMPORTED_MODULE_7___default()(schedule.tanggal).format('YYYY-MM-DD') === moment__WEBPACK_IMPORTED_MODULE_7___default()(_this3.selectedDate).format('YYYY-MM-DD');
        });
      }
  ...
  mounted: function mounted() {
    ...
    var access_token = localStorage.getItem("access_token");
    this.getSchedule();
    axios__WEBPACK_IMPORTED_MODULE_6___default().get("api/routes", {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
