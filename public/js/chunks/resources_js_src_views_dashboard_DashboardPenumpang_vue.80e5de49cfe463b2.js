...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    return {
      icons: {
        ...
        mdiHelpCircle: _mdi_js__WEBPACK_IMPORTED_MODULE_7__.mdiHelpCircle
      }
    };
  },
  data: function data() {
  ...
  methods: {
    getBrands: function getBrands() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_4___default().get("/api/allBrands").then(function (response) {
        _this.brandOptions = response.data;
    ...
    getSchedule: function getSchedule() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_4___default().get("/api/schedule/show/all", {
        headers: {
    ...
    filterSchedules: function filterSchedules() {
      ...
      var filteredSchedules = this.schedules; // Filter berdasarkan tanggal yang dipilih

      if (this.selectedDate) {
        filteredSchedules = filteredSchedules.filter(function (schedule) {
          return moment__WEBPACK_IMPORTED_MODULE_5___default()(schedule.tanggal).format('YYYY-MM-DD') === moment__WEBPACK_IMPORTED_MODULE_5___default()(_this3.selectedDate).format('YYYY-MM-DD');
        });
      ...
      } // Filter berdasarkan tipe bus yang dipilih
      ...
      } // Filter berdasarkan merk bus yang dipilih


      if (this.selectedBrand) {
        filteredSchedules = filteredSchedules.filter(function (schedule) {
          return schedule.brand_id === _this3.selectedBrand;
        });
      } // Filter jadwal yang tidak lebih awal dari saat ini


      filteredSchedules = filteredSchedules.filter(function (schedule) {
        return moment__WEBPACK_IMPORTED_MODULE_5___default()(schedule.tanggal).isSameOrAfter(moment__WEBPACK_IMPORTED_MODULE_5___default()(), 'day') && moment__WEBPACK_IMPORTED_MODULE_5___default()(schedule.tanggal).isSameOrAfter(moment__WEBPACK_IMPORTED_MODULE_5___default()(), 'hour');
      });
      return filteredSchedules;
    },
    countBookings: function countBookings(total) {
      // Menghitung jumlah pemesanan untuk setiap jadwal
      var counts = {};
      this.schedules.forEach(function (schedule) {
        counts[schedule.schedule_id] = 0;
      });
      axios__WEBPACK_IMPORTED_MODULE_4___default().get("/api/bookings/count/".concat(this.selectedDate)).then(function (response) {
        response.data.forEach(function (item) {
          counts[item.schedule_id] = item.total;
        });
      })["catch"](function (error) {
        console.log(error);
      });
    ...
    toggleInfoPopup: function toggleInfoPopup() {
      this.showInfoPopup = !this.showInfoPopup;
    },
    closeInfoPopup: function closeInfoPopup() {
      this.showInfoPopup = false;
    }
  },
  watch: {
    selectedDate: function selectedDate(newDate) {
      // Memanggil ulang perhitungan jumlah pemesanan saat tanggal dipilih berubah
      this.bookingCounts = this.countBookings(newDate);
    }
  },
                ...
                ? _c(
                    ...
                    [
                      ...
                      _vm.showInfoPopup
                        ? _c(
                            "v-overlay",
                            { on: { "click:outside": _vm.closeInfoPopup } },
                            [
                              _c(
                                "v-card",
                                ...
                                [
                                  ...
                                  _c("v-card-text", [
                                    _c("p", [
                                      _vm._v(
                                        "\n                Bus eksekutif menawarkan fasilitas yang lebih baik dan kenyamanan yang lebih tinggi dibandingkan dengan bus ekonomi.\n                Ini bisa mencakup kursi yang lebih lebar dan lebih nyaman, ruang kaki yang lebih lega, hiburan di dalam bus seperti layar TV, sistem audio,\n                dan mungkin juga fasilitas WiFi.\n              "
                                      ),
                                    ]),
                                  ]),
                                ],
                              ...
                              _c(
                                ...
                                [
                                  ...
                                  _c("v-card-text", [
                                    _c("p", [
                                      _vm._v(
                                        "\n                Bus ekonomi merupakan pilihan yang lebih terjangkau bagi mereka yang ingin menghemat biaya perjalanan.\n                Fasilitas yang ditawarkan mungkin lebih sederhana dibandingkan dengan bus eksekutif.\n              "
                                      ),
                                    ]),
                                  ]),
                                ],
