...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    ...
    var isPasswordNowVisible = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__.ref)(false);
    return {
  ...
  methods: {
    logout: function logout() {
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire({
        ...
        if (result.isConfirmed) {
          axios__WEBPACK_IMPORTED_MODULE_1___default().post("/api/logout", null, {
            headers: {
    ...
    editProfile: function editProfile() {
      this.editedUser = (0,D_Other_LARAVUE_APP_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({}, this.user);
    ...
    saveProfileChanges: function saveProfileChanges() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().put("/api/user/update/".concat(this.user.id), this.editedUser, {
        headers: {
        ...
        _this2.isEditing = false; // Disable editing mode after successful update
        ...
        console.log(error.response.data.message); // Optionally, show an error message to the user
