...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    VueOtp2: vue_otp_2__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
  ...
  methods: {
    submitEmail: function submitEmail() {
      ...
      this.isLoading = true;
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("api/reset-password", {
        email: this.email
              ...
              ? _c("v-form", { ref: "form" }, [
                  _c(
                    ...
                    [
                      ...
                      _vm._v(
                        '\n          countdown: "01:00", // Initial countdown time in mm:ss format timer: null, //\n          Variable to store the timer ID\n          '
                      ),
                      _c(
                        "center",
                        [
