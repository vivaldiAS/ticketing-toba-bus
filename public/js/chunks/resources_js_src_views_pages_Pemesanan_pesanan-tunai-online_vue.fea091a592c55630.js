...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    confirmBooking: function confirmBooking(item) {
      var _this2 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
        ...
        if (result.isConfirmed) {
          axios__WEBPACK_IMPORTED_MODULE_0___default().put("/api/konfirmasiberhasiltunai", {
            payment_id: item.payment_id
          }).then(function (response) {
            _this2.getBookings(); // Refresh bookings data


            sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire('Terkonfirmasi!', 'Booking telah dikonfirmasi.', 'success');
          })["catch"](function (error) {
            console.error(error);
            sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire('Error!', 'Terjadi kesalahan saat mengkonfirmasi booking.', 'error');
          });
        }
      });
    },
    cancelBooking: function cancelBooking(item) {
      var _this3 = this;
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
        ...
        if (result.isConfirmed) {
          axios__WEBPACK_IMPORTED_MODULE_0___default().put("/api/batalkanbooking", {
            payment_id: item.payment_id
          }).then(function (response) {
            _this3.getBookings(); // Refresh bookings data


            sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire('Dibatalkan!', 'Booking telah dibatalkan.', 'success');
          })["catch"](function (error) {
            console.error(error);
            sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire('Error!', 'Terjadi kesalahan saat membatalkan booking.', 'error');
          });
        }
      });
    },
                                    ...
                                    "v-btn",
                                    {
                                      ...
                                      on: {
                                        click: function ($event) {
                                          return _vm.confirmBooking(item)
                                        },
                                      },
                                    },
                                    [_vm._v("Konfirmasi")]
