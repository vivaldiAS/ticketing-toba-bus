...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_4___default().get("/api/schedules/driver", {
      ...
      _this.bookingCounts = _this.countBookings(response.data.total); // console.log("iini", this.pesanan);
                      ...
                      [
                        ...
                        _c(
                          ...
                          [
                            ...
                            _vm._v(" "),
                            _vm._l(_vm.bookingCounts, function (count, id) {
                              return !Object.keys(_vm.bookingCounts).includes(
