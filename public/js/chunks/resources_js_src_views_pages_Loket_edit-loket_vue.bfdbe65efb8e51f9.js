...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    ...
    var adminloket = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_6__.ref)({});
    return {
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_5___default().get("/api/loket/get/".concat(id), {
      headers: {
    ...
    axios__WEBPACK_IMPORTED_MODULE_5___default().get("/api/admin-loket/all", {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
      _this.adminloket = Object.values(response.data).map(function (item) {
        return {
          name: item.name,
          id: item.id
        };
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 2;
                _context.next = 5;
                return axios__WEBPACK_IMPORTED_MODULE_5___default().put("/api/user/update/".concat(id), _this2.user, {
                  headers: {
                    Authorization: "Bearer ".concat(access_token)
                  }
                });
