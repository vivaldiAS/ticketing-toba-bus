...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    submitPassword: function submitPassword() {
      ...
      var email = this.$route.params.otp;
      var password = {
        current_password: this.password,
        new_password_confirmation: this.password_confirmation
      };
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/user/update/".concat(email), password).then(function (response) {
        ...
        _this.$router.push("/reset-password");
      });
    }
  }
});
