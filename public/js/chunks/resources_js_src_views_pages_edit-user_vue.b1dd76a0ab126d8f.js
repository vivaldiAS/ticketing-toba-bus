...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    ...
    return _ref = {
      user: ['name', 'email', 'username', 'phone_number', 'address', 'gender'],
      isPasswordVisible: isPasswordVisible
    }, (0,D_Other_LARAVUE_APP_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_ref, "user", {}), (0,D_Other_LARAVUE_APP_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_ref, "icons", {
  ...
  mounted: function mounted() {
    ...
    var id = params;
    axios__WEBPACK_IMPORTED_MODULE_1___default().get('/api/user/get/{id}', {
      headers: {
