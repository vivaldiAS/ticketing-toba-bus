    ...
    BayarNontunai: function BayarNontunai() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().post('api/bookings/nontunai', {
        ...
        if (data.code === 200 && data.data.virtual_account_info.how_to_pay_api) {
          var xml2js = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'xml2js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

          var parser = new xml2js.Parser();
          parser.parseString(data.data.virtual_account_info.how_to_pay_api, function (err, obj) {
            if (err) {
              console.log(err);
            } else {
              console.log(obj);
