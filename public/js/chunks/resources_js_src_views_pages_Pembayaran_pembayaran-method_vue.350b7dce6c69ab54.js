...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      icons: {
        ...
        mdiCreditCard: _mdi_js__WEBPACK_IMPORTED_MODULE_7__.mdiCreditCard,
        mdiCashCheck: _mdi_js__WEBPACK_IMPORTED_MODULE_7__.mdiCashCheck,
        mdiWalletOutline: _mdi_js__WEBPACK_IMPORTED_MODULE_7__.mdiWalletOutline
      },
      bookings: {
        email: ''
      }
  ...
  computed: (0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])((0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({}, (0,vuex__WEBPACK_IMPORTED_MODULE_8__.mapState)(["selectedSeat"])), {}, {
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_3___default().get('api/user/profile', {
      headers: {
  ...
  methods: {
    redirectToLoketPayment: function redirectToLoketPayment() {
      var _this2 = this;

      var access_token = localStorage.getItem("access_token");
      var email = this.user.email;
      var user = this.$store.state.user;
      var schedulesId = this.id_schedule;
      var name = this.passengerData.name;
      var number_phone = this.passengerData.number_phone;
      var alamatJemput = this.passengerData.alamatJemput;
      var num_seats = this.selectedSeat;
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default().post("api/bookings/bayartunai", postData, {
        headers: {
          Authorization: "Bearer ".concat(access_token)
        }
      }).then(function (response) {
        var bookingId = response.data.data.booking_id; // Simpan informasi pemesanan ke dalam local storage

        localStorage.setItem("bookingData", JSON.stringify(response.data.data)); // Pengalihan ke halaman loket pembayaran

        _this2.$router.push({
          name: "loket-payment",
          params: {
            bookingId: bookingId
          } // Gunakan nomor booking sebagai parameter
    ...
    getSchedule: function getSchedule() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default().get(uri, {
        ...
        _this3.schedule = response.data.data;
        console.log(_this3.schedule); //console.log('selingkuh ho', this.selectedSeat);
      })["catch"](function (error) {
        console.log(error);
      });
    },
    BayarCash: function BayarCash() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default().post("api/bookings", {
    ...
    BayarNontunai: function BayarNontunai() {
      ...
      try {
        axios__WEBPACK_IMPORTED_MODULE_3___default().post("api/bookings/nontunai", {
          schedules_id: this.id_schedule,
          name: this.passengerData.name,
          number_phone: this.passengerData.number_phone,
          num_seats: this.selectedSeat,
    ...
    BayarLangsung: function BayarLangsung() {
      var _this7 = this;

      var access_token = localStorage.getItem("access_token");
      var email = this.isAccount ? this.bookings.email : null;
      axios__WEBPACK_IMPORTED_MODULE_3___default().post("api/bookings/bayarcash", {
        schedules_id: this.id_schedule,
        name: this.passengerData.name,
        number_phone: this.passengerData.number_phone,
        num_seats: this.selectedSeat,
                              ...
                              [
                                _c(
                                  ...
                                  [
                                    ...
                                    _c(
                                      "v-col",
                                      { on: { click: _vm.togglePaymentcash } },
                                      [_vm._v("Tunai")]
                                    ),
                                    _vm._v(" "),
                                    _c(
                                                      ...
                                                      "v-btn",
                                                      {
                                                        ...
                                                        on: {
                                                          click: function (
                                                            ...
                                                            $event.preventDefault()
                                                            return _vm.redirectToLoketPayment.apply(
                                                              null,
                                                              arguments
                                                            )
                                                          },
