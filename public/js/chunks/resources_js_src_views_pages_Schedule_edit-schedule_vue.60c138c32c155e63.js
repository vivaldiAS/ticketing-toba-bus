...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    ...
    var selectedBusType = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_6__.ref)("");
    var selectedBusPrice = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_6__.ref)("");
    var filteredRoutes = computed(function () {
      return route.value.filter(function (r) {
        return r.type === selectedBusType.value;
      });
    });
    return {
      schedule: schedule,
      ...
      selectedBusPrice: selectedBusPrice,
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_5___default().get("/api/schedule/show/".concat(id), {
      ...
      _this.selectedBusType = ((_this$bus$find = _this.bus.find(function (bus) {
        return bus.id === _this.schedule.bus_id;
      })) === null || _this$bus$find === void 0 ? void 0 : _this$bus$find.type) || "";
    })["catch"](function (error) {
      console.log(error);
    });
  },
  methods: {
    saveSelectBus: function saveSelectBus() {
      ...
      if (selectedBus) {
        ...
        this.schedule.route_id = ""; // Reset route selection

        this.schedule.harga = null; // Reset harga
      }
    },
...
var render = function () {
  ...
  return _c(
    ...
    { staticClass: "ml-3" },
    [
      _c("v-card-title", [_vm._v("Edit dshJadwal")]),
      _vm._v(" "),
      _c(
        "v-card-text",
        [
