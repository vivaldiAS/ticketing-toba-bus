...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    var errors = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__.ref)({});
    ...
    var busOptions = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__.ref)([]);
    var routeOptions = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__.ref)([]);
    var dayOptions = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__.ref)([{
      text: 'Minggu',
      value: 0
    }, {
      text: 'Senin',
    ...
    var fetchBusOptions = function fetchBusOptions() {
      axios__WEBPACK_IMPORTED_MODULE_3___default().get("/api/buss/show/all").then(function (response) {
    ...
    var fetchRouteOptions = function fetchRouteOptions() {
      axios__WEBPACK_IMPORTED_MODULE_3___default().get("/api/routes/show/all").then(function (response) {
    ...
    var addRoute = function addRoute() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default().post("api/routes/add", {
        bus: data.value.bus,
