...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: (0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])((0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({}, (0,vuex__WEBPACK_IMPORTED_MODULE_6__.mapState)(["selectedSeat"])), {}, {
  ...
  mounted: function mounted() {
    ...
    console.log('nilai selectedSeat pada halaman confirmasi-pesanan.vue:', this.selectedSeat); // Perbarui nilai passenger.name dan passenger.number_phone saat komponen dimuat
  ...
  watch: {
    autoFill: function autoFill(val) {
      if (val) {
        // Jika autoFill aktif, atur input field menjadi tidak readonly
        this.passenger.name = "";
        this.passenger.number_phone = "";
      } else if (this.userRole === 'passenger') {
        // Jika autoFill non-aktif dan userRole adalah 'passenger', atur input field menjadi readonly
