...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    toggleSeat: function toggleSeat(seat) {
    ...
    isSelected: function isSelected(seat) {
      return this.selectedSeats.includes(seat);
    },
    isBooked: function isBooked(seat) {
                                      ...
                                      ? _c(
                                          "div",
                                          {
                                            class: [
                                              ...
                                              {
                                                style: _vm.isSelected(n),
                                                booked: _vm.isBooked(n),
                                              },
                                            ],
                                            on: {
                                              click: function ($event) {
                                                return _vm.toggleSeat(n)
                                              },
                                            },
                                          },
                                          [
