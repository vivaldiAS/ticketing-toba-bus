...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    ...
    var filteredRoutes = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_5__.computed)(function () {
      return route.value.filter(function (route) {
        return route.type === selectedBusType.value;
      });
    });
    return {
      schedule: schedule,
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_4___default().get("/api/routes/show/all", {
      ...
      route.value = response.data.data.filter(function (item) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_4___default().get("/api/buss/show/all", {
      ...
      bus.value = response.data.data.filter(function (item) {
        return item.status === 1;
      }).map(function (item) {
        return {
          id: item.id,
    ...
    axios__WEBPACK_IMPORTED_MODULE_4___default().get("/api/schedule/show/".concat(id), {
      ...
      schedule.value = response.data.data[0];
      schedule.value.route_id = response.data.data[0].route_id;
    })["catch"](function (error) {
      console.log(error);
    });
  },
  methods: {
    ...
    saveSelectRoute: function saveSelectRoute() {
      ...
      var selectedRoute = this.route.find(function (route) {
        return route.id === _this2.schedule.route_id;
      });
