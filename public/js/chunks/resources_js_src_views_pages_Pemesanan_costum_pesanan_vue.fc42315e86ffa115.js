...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (0,D_Other_LARAVUE_APP_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])((0,D_Other_LARAVUE_APP_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({
    ...
    WaitPayment: function WaitPayment() {
      var _this2 = this;

      var access_token = localStorage.getItem("access_token");
      axios__WEBPACK_IMPORTED_MODULE_4___default().get("/api/bookings/show/waiting/schedules/".concat(this.id_schedule), {
        headers: {
          Authorization: "Bearer ".concat(access_token)
        }
      }).then(function (response) {
        //  his.waiting = response.data.data; //
        _this2.waiting = response.data.data.map(function (item) {
          return {
            num_seats: item.num_seats
          };
        });
        console.log("waittt", _this2.waiting);
      })["catch"](function (error) {
        console.log(error);
      });
    },
    getSchedule: function getSchedule() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_4___default().get(uri, {
        ...
        _this3.schedule = response.data.data; // this.number = response.data.data.number_of_seats;
                                      ...
                                      "div",
                                      {
                                        class: [
                                          "pa- text-center  text-no-wrap rounded",
                                          {
                                            ...
                                            waiting: _vm.waiting.some(function (
                                              chair
                                            ) {
                                              return (
                                                chair.num_seats ===
                  ...
                  : _c(
                      ...
                      [
                        _c(
                          "v-row",
                          { attrs: { "no-gutters": "" } },
                          _vm._l(+item.number_of_seats + 2, function (n) {
                            return _c(
                              "v-col",
