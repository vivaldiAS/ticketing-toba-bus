...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      selectedSeatPrice: 0 // Tambahkan properti selectedSeatPrice dan inisialisasi dengan nilai awal
  ...
  methods: (0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])((0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({
    ...
    submitData: function submitData() {
      ...
      if (!isNaN(this.totalHarga) && this.totalHarga !== null) {
        ...
        this.selectedSeatPrice = this.totalHarga; // Tetapkan selectedSeatPrice dengan totalHarga

        this.$store.commit('SET_SELECTED_SEAT_PRICE', this.selectedSeatPrice);
      } else {
    ...
    toggleChairSelection: function toggleChairSelection(seat) {
      if (this.selectedChairs.includes(seat)) {
        this.selectedChairs = this.selectedChairs.filter(function (chair) {
          return chair !== seat;
        });
      } else {
  ...
  watch: {
    selectedChairs: function selectedChairs(newValue) {
