  ...
  methods: (0,E_laragon_www_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])((0,E_laragon_www_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({}, (0,vuex__WEBPACK_IMPORTED_MODULE_11__.mapActions)(["toggleChairSelection"])), {}, {
    ...
    getSchedule: function getSchedule() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default().get("/api/schedule/show/".concat(this.id_schedule), {
        ...
        // Periksa apakah ada pemesanan yang ditemukan
        if (response.data && response.data.data && response.data.data.length > 0) {
          _this2.schedule = response.data.data;
        } else {
          // Jika tidak ada pemesanan yang ditemukan, tampilkan pesan kepada pengguna
          _this2.snackbar.message = "Tidak ada pemesanan yang ditemukan untuk jadwal ini";
          _this2.snackbar.show = true;
        }
      })["catch"](function (error) {
        // Tangani kesalahan saat melakukan permintaan
        console.error(error);
        _this2.snackbar.message = "Terjadi kesalahan saat memuat jadwal pemesanan";
        _this2.snackbar.show = true;
      });
    },
