  ...
  computed: {
    formattedSchedules: function formattedSchedules() {
      ...
      this.schedules.forEach(function (schedule) {
        ...
        if (!formatted[day][day] || schedule.nomor_pintu === formatted[day][day]) {
          formatted[day][day] = schedule.nomor_pintu;
        } else {
          // Menambahkan data duplikat sebagai array
          if (!Array.isArray(formatted[day][day])) {
            formatted[day][day] = [formatted[day][day]];
          }

          formatted[day][day].push(schedule.nomor_pintu);
        }
      });
