  ...
  methods: (0,E_laragon_www_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])((0,E_laragon_www_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({
    ...
    getSchedule: function getSchedule() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_4___default().get("/api/schedule/show/all", {
        ...
        _this2.bookingCounts = _this2.countBookings(response.data.total); // Hitung total_bangku_dibooking

        var total_bangku_dibooking = 0;
        response.data.total.forEach(function (booking) {
          total_bangku_dibooking += booking.num_seats;
        }); // Cetak total_bangku_dibooking ke konsol

        console.log("Total bangku yang dibooking:", total_bangku_dibooking);
      })["catch"](function (error) {
        console.log(error);
      });
    },
