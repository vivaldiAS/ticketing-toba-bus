...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    ...
    var supir = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__.ref)({});
    var loket = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__.ref)({});
    return {
      supir: supir,
      loket: loket,
      mobil: mobil
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_2___default().get("/api/supir/name/all", {
      ...
      _this.supir = Objects.value(response.data).map(function (item) {
        return {
          name: item.name,
          id: item.id
        };
    ...
    axios__WEBPACK_IMPORTED_MODULE_2___default().get("/api/buss/show/all", {
      ...
      _this.bus = response.data.map(function (item) {
        return {
          name: item.name,
          id: item.id
        };
      }); // console.log("ini", this.bus);
    })["catch"](function (error) {
      console.log(error);
    }); // Loket Get
  ...
  methods: {
    UpdateMobil: function UpdateMobil() {
      ...
      var id = this.$route.params.id;
      axios__WEBPACK_IMPORTED_MODULE_2___default().put("/api/buss/update/".concat(id), {
