...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_6___default().get("api/buss/show/all", {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
  ...
  methods: {
    ...
    AddSchedule: function AddSchedule() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_6___default().post("api/schedule/add", {
        ...
        var originalErrors = error.response.data.data;
        _this4.errors_general = error.response.data.message; // Create a new object with the desired format

        _this4.errors = {};

        for (var key in originalErrors) {
          if (Object.prototype.hasOwnProperty.call(originalErrors, key)) {
            var newKey = key.replace("_", " ");
            _this4.errors[newKey] = originalErrors[key];
          }
        }
