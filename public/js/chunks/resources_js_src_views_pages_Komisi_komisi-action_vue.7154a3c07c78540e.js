...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    cancelEdit: function cancelEdit() {
      this.editedData = {
        persentaseKomisi: this.persentaseKomisi,
        setoranKantor: this.setoranKantor,
              ...
              return [
                ...
                _c("tbody", [
                  _c("tr", [
                              ...
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model",
                                  value: _vm.editedData.persentaseKomisi,
                                  expression: "editedData.persentaseKomisi",
                                },
                              ],
                              attrs: { type: "number" },
                              domProps: {
                              ...
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model",
                                  value: _vm.editedData.setoranKantor,
                                  expression: "editedData.setoranKantor",
                                },
                              ],
                              attrs: { type: "number" },
                              domProps: { value: _vm.editedData.setoranKantor },
                              on: {
                                input: function ($event) {
                                  if ($event.target.composing) {
                                    return
                    ...
                    _c("td", [
                      _vm.isEditing
                        ? _c("button", { on: { click: _vm.saveEdit } }, [
                            _vm._v("Simpan"),
                          ])
                        : _vm._e(),
                      _vm._v(" "),
                      _vm.isEditing
                        ...
                        : _c("button", { on: { click: _vm.editFields } }, [
                            _vm._v("Edit"),
                          ]),
                    ]),
                  ]),
...
/* harmony import */ var vuetify_lib_components_VDataTable__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! vuetify/lib/components/VDataTable */ "./node_modules/vuetify/lib/components/VDataTable/VSimpleTable.js");
...
_node_modules_vuetify_loader_lib_runtime_installComponents_js__WEBPACK_IMPORTED_MODULE_4___default()(component, {VSimpleTable: vuetify_lib_components_VDataTable__WEBPACK_IMPORTED_MODULE_5__["default"]})
