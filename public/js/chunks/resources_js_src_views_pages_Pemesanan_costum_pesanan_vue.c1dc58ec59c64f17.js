                                              ...
                                              click: function ($event) {
                                                if (
                                                  ...
                                                  if (
                                                    ...
                                                    _vm.selectedChair.push(
                                                      n > 3 ? n - 1 : n
                                                    )
                                                  } else {
                                                    _vm.selectedChair =
                                                      _vm.selectedChair.filter(
                                                        function (seat) {
                                                          return (
                                                            seat !==
                                                            (n > 3 ? n - 1 : n)
                                                  ...
                                                  this.snackbar.message =
                                                    "Kursi telah dipilih orang lain"
