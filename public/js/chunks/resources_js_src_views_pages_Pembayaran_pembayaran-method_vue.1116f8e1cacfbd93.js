...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      icons: {
        ...
        mdiCreditCard: _mdi_js__WEBPACK_IMPORTED_MODULE_9__.mdiCreditCard,
        mdiCashCheck: _mdi_js__WEBPACK_IMPORTED_MODULE_9__.mdiCashCheck,
        mdiWalletOutline: _mdi_js__WEBPACK_IMPORTED_MODULE_9__.mdiWalletOutline
      },
      bookings: {
        email: ''
      }
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_5___default().get('api/user/profile', {
      headers: {
  ...
  methods: {
    redirectToLoketPayment: function redirectToLoketPayment() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_5___default().post("api/bookings/bayartunai", postData, {
        headers: {
          Authorization: "Bearer ".concat(access_token)
        }
      }).then(function (response) {
    ...
    formatDate: function formatDate(date) {
      ...
      return moment__WEBPACK_IMPORTED_MODULE_6___default()(date).format("dddd, Do MMMM YYYY");
    },
    formatHour: function formatHour(date) {
      moment__WEBPACK_IMPORTED_MODULE_6___default().locale("id");
      return moment__WEBPACK_IMPORTED_MODULE_6___default()(date).format("hh:mm");
    },
    ...
    BayarCash: function BayarCash() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_5___default().post("api/bookings", {
    ...
    BayarNontunai: function BayarNontunai() {
      ...
      try {
        axios__WEBPACK_IMPORTED_MODULE_5___default().post("api/bookings/nontunai", {
          schedules_id: this.id_schedule,
          name: this.passengerData.name,
          number_phone: this.passengerData.number_phone,
          num_seats: this.selectedSeat,
    ...
    BayarLangsung: function BayarLangsung() {
      ...
      var access_token = localStorage.getItem("access_token");
      var email = this.isAccount ? this.bookings.email : null;
      axios__WEBPACK_IMPORTED_MODULE_5___default().post("api/bookings/bayarcash", {
        schedules_id: this.id_schedule,
        name: this.passengerData.name,
        number_phone: this.passengerData.number_phone,
        num_seats: this.selectedSeat,
