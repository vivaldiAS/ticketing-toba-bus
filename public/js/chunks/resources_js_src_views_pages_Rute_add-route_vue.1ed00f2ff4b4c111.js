...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    ...
    var fetchLocations = /*#__PURE__*/function () {
      var _ref = (0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee() {
    ...
    var filteredArrivals = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_6__.computed)(function () {
      if (!routes.value.departure) {
        return [];
      }

      return locations.value.filter(function (location) {
        return location !== routes.value.departure;
      });
    });
    fetchLocations();
    return {
  ...
  methods: {
    ...
    AddRoute: function AddRoute() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_5___default().post("api/routes/add", {
        departure: this.routes.departure,
                    ...
                    [
                      _c("v-select", {
                        attrs: {
                          ...
                          "error-messages": _vm.errors.departure,
                        },
                        on: { change: _vm.filterArrivals },
                        model: {
                          value: _vm.routes.departure,
                          callback: function ($$v) {
                            _vm.$set(_vm.routes, "departure", $$v)
                          },
                          expression: "routes.departure",
                        },
                      }),
                    ],
                    1
