...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    ...
    var fetchDefaultSchedule = /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                _context3.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_7___default().get("/api/default-schedules/4");

              case 3:
                response = _context3.sent;
                // Ganti URL ini sesuai dengan endpoint yang sesuai
                defaultSchedule = response.data;
                data.value.bus = defaultSchedule.bus_id;
                data.value.route = defaultSchedule.route_id;
                data.value.day = defaultSchedule.day_of_week;
                data.value.time = defaultSchedule.time;
                data.value.harga = defaultSchedule.harga;
                _context3.next = 15;
                break;
      ...
      return function fetchDefaultSchedule() {
    ...
    fetchBusOptions();
    fetchRouteOptions();
    fetchDefaultSchedule(); // Panggil fungsi ini untuk mengisi nilai input berdasarkan default schedule.
