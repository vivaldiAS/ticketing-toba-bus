...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    return {
      icons: {// Daftar ikon Anda di sini
      }
    };
  },
  data: function data() {
    return {
      ...
      snackbar: false,
      items: [// Daftar item Anda di sini
      ],
      loket: [// Daftar loket Anda di sini
      ],
      autoFill: false,
      user: {}
    };
  ...
  mounted: function mounted() {
    ...
    } else {// Tindakan jika pengisian otomatis diaktifkan
    }
  },
  watch: {
  ...
  }, (0,vuex__WEBPACK_IMPORTED_MODULE_4__.mapActions)(["setPassengerData"])), {}, {
