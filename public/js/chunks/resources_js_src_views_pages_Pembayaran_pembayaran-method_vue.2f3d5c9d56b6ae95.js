...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    redirectToLoketPayment: function redirectToLoketPayment() {
      ...
      console.log("BUJANK", this.user.id);
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default().post("api/bookings/bayartunai", postData, {
        ...
        localStorage.setItem("bookingData", JSON.stringify(response.data)); // Pengalihan ke halaman loket pembayaran

        _this2.$router.push({
          name: "loket-payment",
          params: {
            id_schedule: schedulesId
          }
        });
      })["catch"](function (error) {
        console.log(error);
