...
/* harmony import */ var moment_locale_id__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! moment/locale/id */ "./node_modules/moment/locale/id.js");
/* harmony import */ var moment_locale_id__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(moment_locale_id__WEBPACK_IMPORTED_MODULE_11__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    return {
      icons: {
        mdiCalendarClock: _mdi_js__WEBPACK_IMPORTED_MODULE_12__.mdiCalendarClock,
        mdiAccountGroup: _mdi_js__WEBPACK_IMPORTED_MODULE_12__.mdiAccountGroup,
  ...
  methods: (0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])((0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({}, (0,vuex__WEBPACK_IMPORTED_MODULE_13__.mapActions)(["toggleChairSelection"])), {}, {
    ...
    proceedToConfirmation: function proceedToConfirmation() {
      if (this.selectedSeat.length > 0) {
        this.$router.push({
          name: 'confirmation',
          query: {
            selectedSeat: this.selectedSeat.join(',')
          }
        });
      } else {
    ...
    getbookingsChair: function getbookingsChair() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default().get("/api/bookings/show/schedules/".concat(this.id_schedule), {
        headers: {
    ...
    getSchedule: function getSchedule() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default().get(uri, {
        headers: {
          Authorization: "Bearer ".concat(access_token)
        }
      }).then(function (response) {
