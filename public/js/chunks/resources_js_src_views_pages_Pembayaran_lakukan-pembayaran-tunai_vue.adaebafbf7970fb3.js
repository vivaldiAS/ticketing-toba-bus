...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (_methods = {
    ...
    // Dalam method startCountdown()
    startCountdown: function startCountdown() {
      var _this3 = this;

      var bookingTime = moment__WEBPACK_IMPORTED_MODULE_4___default()();
      ...
      if (this.schedule.length > 0 && this.expiredDate) {
        // Pastikan expiredDate telah terinisialisasi
        var maxCountdownTime = moment__WEBPACK_IMPORTED_MODULE_4___default().min(departureTime.subtract(1, "hours"), this.expiredDate);
          ...
          _c(
            ...
            [
              ...
              _vm.method && _vm.status && _vm.expiredDate
                ? _c("div", [
                    _c("h4", [
                      _vm._v("Metode Pembayaran: " + _vm._s(_vm.method)),
                    ]),
                    _vm._v(" "),
                    _c("h4", [
                      _vm._v("Status Pembayaran: " + _vm._s(_vm.status)),
                    ]),
                    _vm._v(" "),
                    _c("h4", [
