...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      icons: {
        ...
        mdiMagnify: _mdi_js__WEBPACK_IMPORTED_MODULE_6__.mdiMagnify
      },
      access_token: '',
      showAddForm: false,
      busOptions: [],
  ...
  computed: {
    formattedSchedules: function formattedSchedules() {
      ...
      this.schedules.forEach(function (schedule) {
        var day = daysOfWeek[schedule.day_of_week - 1];
        ...
        formatted[day][day] = schedule.nomor_pintu;
      });
  ...
  methods: {
    fetchSchedules: function fetchSchedules() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_5___default().get('/api/default-schedules', {
        headers: {
    ...
    goToAddDefaultSchedule: function goToAddDefaultSchedule() {
      // Mengarahkan ke halaman add-default-schedule menggunakan router Vue
      this.$router.push({
        name: 'add-default-schedule'
      });
    },
    fetchBusOptions: function fetchBusOptions() {
      var _this2 = this;
      ...
      axios__WEBPACK_IMPORTED_MODULE_5___default().get('/api/buss/show/all', {
        ...
        _this2.busOptions = response.data.data.map(function (bus) {
          return {
    ...
    fetchRouteOptions: function fetchRouteOptions() {
      var _this3 = this;
      ...
      axios__WEBPACK_IMPORTED_MODULE_5___default().get('/api/routes/show/all', {
        ...
        _this3.routeOptions = response.data.data.map(function (route) {
          return {
    ...
    submitDefaultSchedule: function submitDefaultSchedule() {
      var access_token = localStorage.getItem('access_token');
      axios__WEBPACK_IMPORTED_MODULE_5___default().post('/api/default-schedules/add', {
      ...
      }).then(function (response) {// Do something after successful submission
      })["catch"](function (error) {
        console.error(error);
      });
    }
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.v-data-table .v-btn[data-v-2e73b482] {\r\n  min-width: 24px;\n}\r\n", ""]);
// Exports
/* harmony default export */ __webpack_exports__["default"] = (___CSS_LOADER_EXPORT___);
                    ...
                    ? _c(
                        ...
                        [
                          _c(
                            ...
                            {
                              attrs: {
                                color: _vm.getButtonColor(item.monday),
                                dark: "",
                              },
                            },
                            [_vm._v(_vm._s(item.monday))]
                          ),
                        ],
                        1
                      )
                    ...
                    ? _c(
                        ...
                        [
                          _c(
                            ...
                            {
                              attrs: {
                                color: _vm.getButtonColor(item.tuesday),
                                dark: "",
                              },
                            },
                            [_vm._v(_vm._s(item.tuesday))]
                          ),
                        ],
                        1
                      )
                    ...
                    ? _c(
                        ...
                        [
                          _c(
                            ...
                            {
                              attrs: {
                                color: _vm.getButtonColor(item.wednesday),
                                dark: "",
                              },
                            },
                            [_vm._v(_vm._s(item.wednesday))]
                          ),
                        ],
                        1
                      )
                    ...
                    ? _c(
                        ...
                        [
                          _c(
                            ...
                            {
                              attrs: {
                                color: _vm.getButtonColor(item.thursday),
                                dark: "",
                              },
                            },
                            [_vm._v(_vm._s(item.thursday))]
                          ),
                        ],
                        1
                      )
                    ...
                    ? _c(
                        ...
                        [
                          _c(
                            ...
                            {
                              attrs: {
                                color: _vm.getButtonColor(item.friday),
                                dark: "",
                              },
                            },
                            [_vm._v(_vm._s(item.friday))]
                          ),
                        ],
                        1
                      )
                    ...
                    ? _c(
                        ...
                        [
                          _c(
                            ...
                            {
                              attrs: {
                                color: _vm.getButtonColor(item.saturday),
                                dark: "",
                              },
                            },
                            [_vm._v(_vm._s(item.saturday))]
                          ),
                        ],
                        1
                      )
                    ...
                    ? _c(
                        ...
                        [
                          _c(
                            ...
                            {
                              attrs: {
                                color: _vm.getButtonColor(item.sunday),
                                dark: "",
                              },
                            },
                            [_vm._v(_vm._s(item.sunday))]
                          ),
                        ],
                        1
                      )
                    ...
                    "v-form",
                    {
                      on: {
                        submit: function ($event) {
                          ...
                          return _vm.submitDefaultSchedule.apply(
                            null,
                            arguments
                          )
                        },
                          ...
                          _c(
                            ...
                            [
                              _c("v-select", {
                                ...
                                model: {
                                  value: _vm.selectedBus,
                                  callback: function ($$v) {
                                    _vm.selectedBus = $$v
                                  },
                                  expression: "selectedBus",
                                },
                              }),
                            ],
                            1
