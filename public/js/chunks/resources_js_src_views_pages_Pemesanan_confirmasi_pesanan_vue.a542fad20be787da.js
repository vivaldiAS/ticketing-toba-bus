...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  // Dalam file store Vuex, tambahkan action untuk mengatur nilai selectedSeat
  actions: {
    setSelectedSeats: function setSelectedSeats(_ref, seats) {
  ...
  mounted: function mounted() {
    ...
    console.log('nilai selectedSeat pada halaman confirmasi-pesanan.vue:', this.selectedSeat); // Tambahkan baris ini
