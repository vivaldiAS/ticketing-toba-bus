...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    updatebrand: function updatebrand() {
      ...
      return (0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee2() {
        var access_token, id;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.prev = 2;
                _context2.next = 5;
                return axios__WEBPACK_IMPORTED_MODULE_6___default().put("/api/brand/update/".concat(id), _this2.brand, {
                  headers: {
                    Authorization: "Bearer ".concat(access_token)
                  }
                });
              ...
              case 8:
                ...
                console.error(_context2.t0); // Handle error, show an error message, or perform any other actions.
