    ...
    confirmBooking: function confirmBooking(id) {
      sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
        ...
        if (result.isConfirmed) {
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire('Konfirmasi Berhasil!', '', 'success'); // Tambahkan logika untuk mengirimkan permintaan ke backend untuk mengkonfirmasi booking
        }
      });
    },
    cancelBooking: function cancelBooking(id) {
      sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
        ...
        if (result.isConfirmed) {
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire('Booking Dibatalkan!', '', 'success'); // Tambahkan logika untuk mengirimkan permintaan ke backend untuk membatalkan booking
        }
      });
    }
  },
      ...
      : _c(
          ...
          _vm._l(_vm.bookings, function (booking) {
            return _c("div", { key: booking.id }, [
              ...
              _c("p", [
                _vm._v(
                  "Harga Total: " + _vm._s(booking.harga * booking.num_seats)
                ),
              ]),
              _vm._v(" "),
              _c(
