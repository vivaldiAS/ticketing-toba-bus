...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    updateStatus: function updateStatus(id) {
      ...
      return (0,D_Other_LARAVUE_APP_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee2() {
        var access_token, updatedStatus;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                access_token = localStorage.getItem("access_token");
                updatedStatus = _this.adminLoket.status == 1 ? 0 : 1;
                sweetalert2__WEBPACK_IMPORTED_MODULE_3___default().fire({
                  ...
                  var _ref = (0,D_Other_LARAVUE_APP_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(result) {
                    var response;
                      ...
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            ...
                            _context.prev = 1;
                            _context.next = 4;
                            return axios__WEBPACK_IMPORTED_MODULE_2___default().put("/api/account/update/status/".concat(id), {
                              status: updatedStatus
                            }, // Pass the updated status in the request body
                            {
                              headers: {
                          ...
                          case 4:
                            ...
                            _this.adminLoket.status = response.data.data.status;
                            _context.next = 11;
                            break;
                          ...
                          case 11:
                            sweetalert2__WEBPACK_IMPORTED_MODULE_3___default().fire("Updated", "The status has been updated.", "success");
                            _context.next = 15;
                            break;

                          case 14:
                            _this.$refs.switchStatus.value = _this.adminLoket.status;
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_2___default().get('/api/admin-loket/all', {
      headers: {
        'Authorization': "Bearer ".concat(access_token)
      }
    }).then(function (response) {
      _this2.adminLoket = response.data;
      console.log(_this2.adminLoket);
          ...
          },
          {
            ...
            fn: function (ref) {
              ...
              return [
                _c("v-switch", {
                  attrs: {
                    "this.$refs.switchStatus.value": "this.adminLoket.status;",
                    color: "secondary",
                    inset: "",
                  },
                  on: {
