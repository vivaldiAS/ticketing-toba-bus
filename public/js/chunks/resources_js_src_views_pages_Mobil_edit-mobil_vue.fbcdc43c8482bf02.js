...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    var access_token = localStorage.getItem("access_token"); // Mendapatkan data supir
    ...
    axios__WEBPACK_IMPORTED_MODULE_3___default().get("/api/bus/get/".concat(id), {
      ...
      _this.mobil.value = response.data.data[0];
      console.log("all bus", _this.mobil.value);
    })["catch"](function (error) {
      console.log(error);
    });
  },
