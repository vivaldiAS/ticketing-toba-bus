...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchSupir: function fetchSupir() {
      var _this = this;
    ...
    fetchLoket: function fetchLoket() {
      var _this2 = this;
      ...
      axios__WEBPACK_IMPORTED_MODULE_4___default().get("/api/loket/all", {
        ...
        _this2.loket = response.data.filter(function (item) {
          return item.status == 1;
        }).map(function (item) {
          return {
    ...
    addMobil: function addMobil() {
      ...
      var access_token = localStorage.getItem("access_token");
      axios__WEBPACK_IMPORTED_MODULE_4___default().post("/api/buss/add", this.mobil, {
        headers: {
          Authorization: "Bearer ".concat(access_token)
        }
      }).then(function (response) {
