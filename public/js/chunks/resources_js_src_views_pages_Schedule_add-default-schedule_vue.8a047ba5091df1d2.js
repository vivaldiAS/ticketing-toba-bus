...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    Vue.use((vue_the_mask__WEBPACK_IMPORTED_MODULE_6___default()));
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                _context.next = 4;
                return axios__WEBPACK_IMPORTED_MODULE_8___default().get("/api/buss/show/all", {
                  headers: {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.prev = 1;
                _context2.next = 4;
                return axios__WEBPACK_IMPORTED_MODULE_8___default().get("/api/routes/show/all", {
                  headers: {
                    Authorization: "Bearer ".concat(access_token)
                  }
                });
              ...
              case 4:
                ...
                routeOptions.value = response.data.data.map(function (route) {
                  return {
                    ...
                    value: route.id,
                    harga: route.harga // Menambahkan properti harga ke dalam opsi rute
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.prev = 1;
                _context3.next = 4;
                return axios__WEBPACK_IMPORTED_MODULE_8___default().post("/api/default-schedules/add", {
