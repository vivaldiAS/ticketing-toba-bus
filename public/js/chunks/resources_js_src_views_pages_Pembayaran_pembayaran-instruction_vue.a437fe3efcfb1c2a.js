    ...
    [
      ...
      _vm.paymentInstructions.virtual_account_info.status == "PAID"
        ? _c("v-card", { staticClass: "payment-success-card" }, [
            _c(
              "div",
              { staticClass: "checklist-icon-container" },
              [
                _c(
                  "v-icon",
                  { staticClass: "checklist-icon", attrs: { "x-large": "" } },
                  [_vm._v(_vm._s(_vm.icons.mdiCheckCircleOutline))]
                ),
                _vm._v(" "),
                _c("div", { staticClass: "checklist-icon-overlay" }),
              ],
              1
            ),
            _vm._v(" "),
            _c("div", { staticClass: "payment-success-content" }, [
              ...
              _vm._v(" "),
              _c("h1", [_vm._v("Pembayaran Berhasil")]),
              _vm._v(" "),
              _c("p", [
                _c("strong", [_vm._v("Amount:")]),
                _vm._v(" " + _vm._s(_vm.paymentInstructions.order.amount)),
              ...
              _vm._v(" "),
              _c("p", [
                _c("strong", [_vm._v("Email in:")]),
                _vm._v(" " + _vm._s(_vm.paymentInstructions.customer.email)),
              ]),
              _vm._v(" "),
              _c("p", [
                _c("strong", [_vm._v("Status Pembayaran: ")]),
                _vm._v(" Berhasil"),
              ]),
            ]),
          ])
