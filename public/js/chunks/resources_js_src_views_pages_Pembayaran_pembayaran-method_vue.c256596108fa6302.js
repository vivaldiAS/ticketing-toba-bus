  ...
  methods: {
    ...
    BayarNontunai: function BayarNontunai() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().post('api/bookings/nontunai', {
        ...
        if (data.code === 200 && data.data.virtual_account_info.how_to_pay_page) {
          var xmlString = data.data.virtual_account_info.how_to_pay_page;
          console.log(xmlString); // Buat instance DOMParser untuk mengurai XML

          var parser = new DOMParser();
          var xmlDoc = parser.parseFromString(xmlString, 'text/xml'); // Dapatkan elemen-elemen yang diperlukan dalam Vue.js template

          var namaElemen1 = xmlDoc.querySelector('h5').textContent;
          var namaElemen2 = xmlDoc.querySelector('h6').textContent; // Gunakan variabel "namaElemen1" dan "namaElemen2" untuk tindakan selanjutnya

          console.log(namaElemen1);
          console.log(namaElemen2);
        } else {
