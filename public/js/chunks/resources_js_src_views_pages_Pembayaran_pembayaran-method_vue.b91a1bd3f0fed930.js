...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    redirectToLoketPayment: function redirectToLoketPayment() {
      ...
      var userId = this.$store.state.userData.id; // Mengambil ID user yang sedang login dari store
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default().post("api/bookings/bayartunai", {
        user_id: userId,
    ...
    getSchedule: function getSchedule() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default().get(uri, {
        ...
        console.log(_this2.schedule); //console.log('selingkuh ho', this.selectedSeat);
      })["catch"](function (error) {
        console.log(error);
      });
    },
