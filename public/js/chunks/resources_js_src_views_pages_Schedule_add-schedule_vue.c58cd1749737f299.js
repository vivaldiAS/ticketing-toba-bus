  ...
  methods: {
    ...
    saveSelectBus: function saveSelectBus() {
      ...
      if (selectedBus) {
        ...
        // Filter rute berdasarkan lokasi loket bus yang dipilih

        this.route = this.route.filter(function (route) {
          return route.derpature.includes(selectedBus.lokasi_loket) || route.arrival.includes(selectedBus.lokasi_loket);
        });
      }
    },
