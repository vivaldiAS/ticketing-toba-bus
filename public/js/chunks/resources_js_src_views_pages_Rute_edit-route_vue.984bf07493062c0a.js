...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    var routes = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_1__.ref)({}); // Declare user as a ref
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/routes/get/".concat(id), {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
