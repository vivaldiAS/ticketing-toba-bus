...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    if (!this.autoFill) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_4___default().get("api/user/profile", {
        headers: {
  ...
  watch: {
    autoFill: function (_autoFill) {
      function autoFill(_x) {
        return _autoFill.apply(this, arguments);
      }

      autoFill.toString = function () {
        return _autoFill.toString();
      };
  ...
  }, (0,vuex__WEBPACK_IMPORTED_MODULE_8__.mapActions)(["setPassengerData"])), {}, {
