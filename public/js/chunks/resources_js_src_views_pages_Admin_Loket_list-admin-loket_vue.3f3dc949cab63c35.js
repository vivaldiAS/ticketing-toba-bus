          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                console.log(response.data); // update status bus pada halaman

                _this.bus.status = response.data.data.status;
                _this.StatusBus = response.data.data.status;

                _this.sentDataToSocket();
