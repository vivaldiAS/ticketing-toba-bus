...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    submitOtp: function submitOtp() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_5___default().get("api/getOtp", {
        email: this.email,
        otp: this.otpCode
      }).then(function (response) {
        _this2.msg = response.data;
        console.log(_this2.msg);
        sweetalert2__WEBPACK_IMPORTED_MODULE_6___default().fire({
          icon: "success",
          title: "OTP Submitted",
          text: _this2.otpCode + _this2.msg.otp,
          confirmButtonText: "Ok",
          confirmButtonColor: "#d33"
        });
      })["catch"](function (error) {
    ...
    startCountdown: function startCountdown() {
      ...
      this.timer = setInterval(function () {
        ...
        _this3.countdown = "".concat(minutes.toString().padStart(2, "0"), ":").concat(seconds.toString().padStart(2, "0"));
        remainingSeconds--;
