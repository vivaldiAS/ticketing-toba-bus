...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    countBookings: function countBookings(total) {
      // Simulasi data jumlah pemesanan
      var counts = {};
      this.schedules.forEach(function (schedule) {
        counts[schedule.schedule_id] = Math.floor(Math.random() * total); // Generate random counts for each schedule
      });
      return counts;
    }
  },
