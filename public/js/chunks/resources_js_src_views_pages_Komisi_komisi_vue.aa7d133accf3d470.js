...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      headers: [{
        ...
        text: "Total Setoran Admin Loket",
        value: "jumlah"
      }, {
        text: "Komisi Adm/agen",
        value: "adm"
      }, {
        text: "Komisi Perusahaan",
        value: "perusahaan"
      }, {
        text: "Detail",
        value: "Detail",
  ...
  mounted: function mounted() {
    ...
    var access_token = localStorage.getItem("access_token"); // console.log(combinedDat);
    ...
    axios__WEBPACK_IMPORTED_MODULE_6___default().get(url, {
      ...
      _this.JumlahTanggal = response.data.total;
  ...
  methods: {
    formatDate: function formatDate(date) {
      return moment__WEBPACK_IMPORTED_MODULE_5___default()(date).format("dddd, Do MMMM YYYY");
    },
    JumlahSetoran: function JumlahSetoran(total, jlhTgl) {
      return total - (0.1 * total + jlhTgl * 53000 + jlhTgl * 5000);
    },
    perusahaan: function perusahaan(total, jlhTgl) {
      return 60 / 100 * (10 / 100 * total) + jlhTgl * 53000 + jlhTgl * 5000;
    },
    Adm: function Adm(total) {
  ...
  computed: {
    ...
    filteredItems: function filteredItems() {
      ...
      if (!this.selectedDate) {
        ...
        return this.combinedData.filter(function (item) {
          return moment__WEBPACK_IMPORTED_MODULE_5___default()(item.tanggal).format("YYYY-MM-DD") === _this2.selectedDate;
        });
      }
    },
    combinedData: function combinedData() {
      ...
      return this.ListByDate.map(function (item) {
        var match = _this3.JumlahTanggal.find(function (t) {
          return t.tanggal === item.tanggal;
        });

        return (0,E_laragon_www_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])((0,E_laragon_www_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({}, item), {}, {
  ...
  watch: {
    selectedDate: function selectedDate(newVal, oldVal) {
      if (!newVal) {
        this.filteredItemsList = this.ListByDate;
      } else {
        this.filteredItemsList = this.ListByDate.filter(function (item) {
          return moment__WEBPACK_IMPORTED_MODULE_5___default()(item.tanggal).format("YYYY-MM-DD") === newVal;
        });
      }
    }
  }
