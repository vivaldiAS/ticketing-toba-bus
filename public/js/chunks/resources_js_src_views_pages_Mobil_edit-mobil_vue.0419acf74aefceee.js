...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    ...
    var mobil = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__.ref)([]);
    return {
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_2___default().get("/api/buss/show/all", {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_2___default().get("/api/loket/all", {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
      _this.loket = response.data.map(function (item) {
        return {
    ...
    axios__WEBPACK_IMPORTED_MODULE_2___default().get("/api/bus/get/".concat(id), {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
      _this.mobil = response.data.data;
      console.log(_this.mobil);
    })["catch"](function (error) {
      console.log(error);
    });
  },
