...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    ...
    var user = ['name', 'email', 'username', 'phone_number', 'address', 'gender', 'password', 'confirm_password'];
    var socialLink = [{
