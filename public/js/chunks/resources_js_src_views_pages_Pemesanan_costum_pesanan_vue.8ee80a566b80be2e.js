...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    submitData: function submitData() {
      ...
      if (!isNaN(this.totalHarga) && this.totalHarga !== null) {
        ...
        this.$store.commit('SET_SELECTED_SEATS', this.selectedSeats);
    ...
    toggleChairSelection: function toggleChairSelection(seat) {
      if (this.selectedSeats.includes(seat)) {
        this.selectedSeats = this.selectedSeats.filter(function (chair) {
          return chair !== seat;
        });
      } else {
  ...
  watch: {
    selectedSeats: function selectedSeats(newValue) {
