  ...
  methods: (0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])((0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({}, (0,vuex__WEBPACK_IMPORTED_MODULE_11__.mapActions)(["toggleChairSelection"])), {}, {
    ...
    getBookingsChair: function getBookingsChair() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default().get("/api/bookings/show/schedules/".concat(this.id_schedule), {
        ...
        _this.bookingsChair = response.data.data.flatMap(function (item) {
    ...
    getSchedule: function getSchedule() {
      ...
      var access_token = localStorage.getItem("access_token");
      axios__WEBPACK_IMPORTED_MODULE_9___default().get("/api/schedule/show/".concat(this.id_schedule), {
        headers: {
          Authorization: "Bearer ".concat(access_token)
        }
      }).then(function (response) {
