  ...
  methods: {
    ...
    getSchedule: function getSchedule() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().get(uri, {
        ...
        console.log(_this.schedule); // Pastikan ada jadwal yang diterima sebelum memanggil startCountdown()
    ...
    startCountdown: function startCountdown() {
      ...
      if (this.schedule) {
        var departureTime = moment__WEBPACK_IMPORTED_MODULE_3___default()(this.schedule.date);
      ...
      _vm.paymentData
        ? _c(
            ...
            [
              _c("v-card-title", [
                _vm._v(
                  "Lakukan Pembayaran ke Loket " +
                    _vm._s(_vm.schedule.departure)
                ),
              ]),
              _vm._v(" "),
              _c(
                ...
                [
                  _c("h2", [
                    _vm._v(
                      _vm._s(_vm.schedule.departure) +
                        " -> " +
                        _vm._s(_vm.schedule.arrival)
                    ),
                  ]),
                  _vm._v(" "),
                  _c("h5", [_vm._v(_vm._s(_vm.formatHour(_vm.schedule.date)))]),
                  _vm._v(" "),
                  _c("h5", [_vm._v(_vm._s(_vm.formatDate(_vm.schedule.date)))]),
                  _vm._v(" "),
                  _c("h5", [
                    _vm._v(
                      _vm._s(
                        _vm._f("toRupiah")(
                          _vm.schedule.price * _vm.selectedSeat.length
                        )
                      )
                    ),
                  ]),
                  ...
                  _vm._v(" "),
                  _c("h4", [_vm._v("Detail Pembayaran:")]),
                  _vm._v(" "),
                  _c("p", [
                    _c("strong", [_vm._v("Invoice Number:")]),
                    _vm._v(" " + _vm._s(_vm.paymentData.invoice_number)),
                  ]),
                  _vm._v(" "),
                  _c("p", [
                    _c("strong", [_vm._v("Total Amount:")]),
                    _vm._v(
                      " " + _vm._s(_vm._f("toRupiah")(_vm.paymentData.amount))
                    ),
                  ]),
                  _vm._v(" "),
                  _c("p", [
                    _c("strong", [_vm._v("Expired Date:")]),
                    _vm._v(" " + _vm._s(_vm.paymentData.expired_date)),
                  ]),
                ],
                1
              ),
