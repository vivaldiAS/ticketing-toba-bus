...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      icons: {
        ...
        mdiMagnify: _mdi_js__WEBPACK_IMPORTED_MODULE_4__.mdiMagnify
      },
      access_token: '' // Tambahkan variabel access_token di sini
  ...
  computed: {
    formattedSchedules: function formattedSchedules() {
      ...
      this.schedules.forEach(function (schedule) {
        var day = daysOfWeek[schedule.day_of_week - 1]; // Adjust day_of_week to 0-indexed for the array
  ...
  methods: {
    fetchSchedules: function fetchSchedules() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default().get('/api/default-schedules', {
        headers: {
          Authorization: "Bearer ".concat(access_token)
        }
      }).then(function (response) {
        _this.schedules = response.data;
        _this.access_token = access_token; // Simpan access_token ke dalam variabel data setelah fetch selesai

        console.log("AKSES TOKEN: ", _this.access_token); // Cetak access_token setelah fetch selesai
  ...
  return _c(
    ...
    [
      _c(
        "v-card-title",
        [
          _c("v-btn", { staticClass: "mb-3", attrs: { color: "primary" } }, [
            _vm._v("\n      Tambah Jadwal\n    "),
          ]),
          _vm._v(" "),
          _c("v-spacer"),
        ...
        scopedSlots: _vm._u([
          {
            ...
            fn: function (ref) {
              ...
              return [
                _c("tr", [
                  _c("td", [_vm._v(_vm._s(item.monday))]),
                  _vm._v(" "),
                  _c("td", [_vm._v(_vm._s(item.tuesday))]),
                  _vm._v(" "),
                  _c("td", [_vm._v(_vm._s(item.wednesday))]),
                  _vm._v(" "),
                  _c("td", [_vm._v(_vm._s(item.thursday))]),
                  _vm._v(" "),
                  _c("td", [_vm._v(_vm._s(item.friday))]),
                  _vm._v(" "),
                  _c("td", [_vm._v(_vm._s(item.saturday))]),
                  _vm._v(" "),
                  _c("td", [_vm._v(_vm._s(item.sunday))]),
                ]),
              ]
            },
          },
