...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    ...
    var adminloket = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_5__.ref)({});
    return {
      adminloket: [],
      admin: null,
      loket: loket
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_4___default().get("/api/loket/get/".concat(id), {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
      _this.loket = response.data.data; // console.log(this.user);
    ...
    axios__WEBPACK_IMPORTED_MODULE_4___default().get("api/admin-loket/all", {
      ...
      _this.lokets = response.data.map(function (item) {
        return {
          name: item.name,
          id: item.id
        };
      });
      console.log("ini", _this.lokets);
    })["catch"](function (error) {
      console.log(error);
    });
  },
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 2;
                _context.next = 5;
                return axios__WEBPACK_IMPORTED_MODULE_4___default().put("/api/user/update/".concat(id), _this2.user, {
                  headers: {
                    Authorization: "Bearer ".concat(access_token)
                  }
                });
                        ...
                        "v-btn",
                        {
                          ...
                          on: {
                            click: function ($event) {
                              ...
                              return _vm.Editloket.apply(null, arguments)
                            },
                          },
                        },
                        [_vm._v(" Submit ")]
