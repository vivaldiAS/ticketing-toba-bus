...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (0,D_Other_LARAVUE_APP_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])((0,D_Other_LARAVUE_APP_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({
    getColSize: function getColSize(n) {
      if (n <= 3) {
        return '100px'; // Lebar kolom untuk bagian depan (2 kursi)
      } else if (n <= 5) {
        return '75px'; // Lebar kolom untuk baris kedua (4 kursi dengan spasi)
      } else if (n <= 9) {
        return '75px'; // Lebar kolom untuk baris ketiga (4 kursi dengan spasi)
      } else if (n <= 12) {
        return '75px'; // Lebar kolom untuk baris keempat (4 kursi dengan spasi)
      } else {
        return '75px'; // Lebar kolom untuk baris kelima (4 kursi rapat)
      }
    },
