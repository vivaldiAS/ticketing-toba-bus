...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    return {
      icons: {
        ...
        mdiHelpCircle: _mdi_js__WEBPACK_IMPORTED_MODULE_8__.mdiHelpCircle,
        mdiClose: _mdi_js__WEBPACK_IMPORTED_MODULE_8__.mdiClose
      }
    };
  },
  data: function data() {
  ...
  methods: (0,E_laragon_www_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])((0,E_laragon_www_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({
    getBrands: function getBrands() {
      var _this = this;

      axios__WEBPACK_IMPORTED_MODULE_5___default().get("/api/allBrands").then(function (response) {
    ...
    getSchedule: function getSchedule() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_5___default().get("api/routes", {
        headers: {
          Authorization: "Bearer ".concat(access_token)
        }
      }).then(function (response) {
        _this2.route = response.data.data.map(function (item) {
          return {
            id: item.id,
    ...
    filterSchedules: function filterSchedules() {
      ...
      filteredSchedules = filteredSchedules.filter(function (schedule) {
        return moment__WEBPACK_IMPORTED_MODULE_6___default()(schedule.tanggal).isSameOrAfter(moment__WEBPACK_IMPORTED_MODULE_6___default()(), "day");
      });

      if (this.selectedDate) {
        filteredSchedules = filteredSchedules.filter(function (schedule) {
          return moment__WEBPACK_IMPORTED_MODULE_6___default()(schedule.tanggal).format("YYYY-MM-DD") === moment__WEBPACK_IMPORTED_MODULE_6___default()(_this3.selectedDate).format("YYYY-MM-DD");
        });
      }
      ...
      if (this.selectedBrand) {
        var selectedBrandId = this.selectedBrand;
        filteredSchedules = filteredSchedules.filter(function (schedule) {
