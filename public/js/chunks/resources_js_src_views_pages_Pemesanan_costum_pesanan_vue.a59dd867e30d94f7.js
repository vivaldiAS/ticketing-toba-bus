  ...
  methods: {
    ...
    submitData: function submitData() {
      ...
      if (!isNaN(this.totalHarga) && this.totalHarga !== null) {
        // Simpan data bangku yang dipilih ke dalam variabel selectedSeat
        this.$store.commit('SET_SELECTED_SEATS', this.selectedSeat.slice()); // Salin nilai array dengan slice()
