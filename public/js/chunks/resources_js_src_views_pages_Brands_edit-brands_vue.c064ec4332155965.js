...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    var brand = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__.ref)({
      nama_brand: "",
      admin: ""
    });
    var adminbrand = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__.ref)([]);
    return {
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_7___default().get("/api/brands/".concat(id), {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
      _this.brand = response.data.data;
      _this.brand.admin = response.data.data.admin_id;
    })["catch"](function (error) {
      console.log(error);
    });
    axios__WEBPACK_IMPORTED_MODULE_7___default().get("/api/admin-brand/all", {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
      _this.adminbrand = Object.values(response.data).filter(function (item) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 2;
                _context.next = 5;
                return axios__WEBPACK_IMPORTED_MODULE_7___default().put("/api/brand/update/".concat(id), _this2.brand, {
                  headers: {
                    Authorization: "Bearer ".concat(access_token)
                  }
                });
