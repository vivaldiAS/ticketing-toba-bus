...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    return {
      icons: {
        mdiSofaSingleOutline: _mdi_js__WEBPACK_IMPORTED_MODULE_12__.mdiSofaSingleOutline,
        mdiSofaSingle: _mdi_js__WEBPACK_IMPORTED_MODULE_12__.mdiSofaSingle,
        mdiChevronRight: _mdi_js__WEBPACK_IMPORTED_MODULE_12__.mdiChevronRight,
        mdiSteering: _mdi_js__WEBPACK_IMPORTED_MODULE_12__.mdiSteering
      }
    };
  },
  data: function data() {
  ...
  computed: (0,E_laragon_www_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_1__["default"])((0,E_laragon_www_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_1__["default"])({}, (0,vuex__WEBPACK_IMPORTED_MODULE_13__.mapState)(["busData"])), {}, {
  ...
  methods: (0,E_laragon_www_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_1__["default"])((0,E_laragon_www_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_1__["default"])({}, (0,vuex__WEBPACK_IMPORTED_MODULE_13__.mapActions)(["toggleChairSelection"])), {}, {
    ...
    getSchedule: function getSchedule() {
      ...
      return (0,E_laragon_www_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee() {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return axios__WEBPACK_IMPORTED_MODULE_11___default().get("/api/schedule/show/".concat(_this.id_schedule), {
                  headers: {
              ...
              case 4:
                ...
                _this.schedule = response.data.data || []; // Ensure schedule is an array
    ...
    getBookingsChair: function getBookingsChair() {
      ...
      return (0,E_laragon_www_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee2() {
        var access_token, response;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                access_token = localStorage.getItem("access_token");
                _context2.next = 4;
                return axios__WEBPACK_IMPORTED_MODULE_11___default().get("/api/bookings/show/schedules/".concat(_this2.id_schedule), {
                  headers: {
                    Authorization: "Bearer ".concat(access_token)
                  }
                });
              ...
              case 4:
                ...
                _this2.bookingsChair = response.data.data.flatMap(function (item) {
                  return item.seat_numbers;
                }) || []; // Ensure bookingsChair is an array
