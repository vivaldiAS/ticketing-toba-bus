...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    return {
      adminkantor: ['name', 'email', 'username', 'phone_number', 'address', 'gender', 'status'],
      icons: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                _this.adminkantor.find(function (admin) {
                  return admin.id === id;
    ...
    showConfirmation: function showConfirmation(id) {
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
        ...
        if (result.isConfirmed) {
          ...
          var admin = _this2.adminkantor.find(function (adminkantor) {
            return adminkantor.id === id;
          });
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_4___default().get('/api/GetAdminKantor', {
      ...
      _this3.adminkantor = response.data;
      console.log(_this3.adminkantor);
