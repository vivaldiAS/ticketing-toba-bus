    ...
    BayarNontunai: function BayarNontunai() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().post('api/bookings/nontunai', {
        ...
        if (data.code === 200 && data.data.virtual_account_info.how_to_pay_api) {
          var xmlString = data.data.virtual_account_info.how_to_pay_api; // console.log(xml);
          // Buat instance DOMParser untuk mengurai XML
          ...
          var namaElemen2 = xmlDoc.querySelector('h6').textContent;
        } else {
