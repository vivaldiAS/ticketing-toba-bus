...
/* harmony import */ var E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/slicedToArray */ "./node_modules/@babel/runtime/helpers/esm/slicedToArray.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      icons: {
        mdiPencil: _mdi_js__WEBPACK_IMPORTED_MODULE_10__.mdiPencil,
        mdiMagnify: _mdi_js__WEBPACK_IMPORTED_MODULE_10__.mdiMagnify
      },
      access_token: ''
    };
  },
  computed: {
    formattedSchedules: function formattedSchedules() {
      ...
      this.schedules.forEach(function (schedule) {
        var day = _this.getDayName(schedule.day_of_week);

        if (!formatted[day]) {
          formatted[day] = [];
        }

        formatted[day].push(schedule.nomor_pintu);
      }); // Urutkan data berdasarkan waktu

      Object.values(formatted).forEach(function (arr) {
        arr.sort(function (a, b) {
          var timeA = _this.getTime(a);

          var timeB = _this.getTime(b);
  ...
  methods: {
    fetchSchedules: function fetchSchedules() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default().get('/api/default-schedules', {
        headers: {
    ...
    getDayName: function getDayName(dayIndex) {
    ...
    getTime: function getTime(timeString) {
      // Mengembalikan waktu dalam format yang dapat diurutkan
      var _timeString$split = timeString.split(':'),
          _timeString$split2 = (0,E_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_0__["default"])(_timeString$split, 3),
                      ...
                      [
                        item[day]
                          ? _c(
                              ...
                              {
                                attrs: {
                                  color: _vm.getButtonColor(item[day]),
                                  dark: "",
                                },
                              },
