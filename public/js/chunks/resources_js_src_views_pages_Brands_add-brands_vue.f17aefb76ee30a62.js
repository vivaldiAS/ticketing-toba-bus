...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_4___default().get("api/GetAdminKantor/notAssociated", {
      headers: {
  ...
  methods: {
    AddBrand: function AddBrand() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_4___default().post("/registrasi/brands", {
