...
/* harmony import */ var moment_locale_id__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! moment/locale/id */ "./node_modules/moment/locale/id.js");
/* harmony import */ var moment_locale_id__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(moment_locale_id__WEBPACK_IMPORTED_MODULE_9__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    return {
      icons: {
        mdiCalendarClock: _mdi_js__WEBPACK_IMPORTED_MODULE_10__.mdiCalendarClock,
        mdiAccountGroup: _mdi_js__WEBPACK_IMPORTED_MODULE_10__.mdiAccountGroup,
        mdiAccount: _mdi_js__WEBPACK_IMPORTED_MODULE_10__.mdiAccount,
        mdiHelpCircle: _mdi_js__WEBPACK_IMPORTED_MODULE_10__.mdiHelpCircle
      }
    };
  },
  data: function data() {
    return {
      ...
      brands: [],
      brandOptions: [],
      // Initialize the brandOptions array
      selectedDate: null,
      selectedRoute: null,
      selectedType: null,
      showTypeInfo: false,
      // Add this line to track the visibility of the info pop-up
      schedules: [],
      bookingCounts: {},
      route: [],
      busData: {
  ...
  methods: (0,E_laragon_www_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_1__["default"])((0,E_laragon_www_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_1__["default"])({
    getBrands: function getBrands() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_7___default().get("/api/allBrands").then(function (response) {
        _this.brandOptions = response.data; // Directly assign the data array
      })["catch"](function (error) {
        console.log(error);
      });
    }
  }, (0,vuex__WEBPACK_IMPORTED_MODULE_11__.mapActions)(["setSelectedSeat"])), {}, (_objectSpread2 = {
    ...
    formatDate: function formatDate(date) {
      moment__WEBPACK_IMPORTED_MODULE_8___default().locale("id");
      return moment__WEBPACK_IMPORTED_MODULE_8___default()(date).format("dddd, Do MMMM YYYY, hh:mm:ss");
    },
    getSchedule: function getSchedule() {
      var _this2 = this;

      var access_token = localStorage.getItem("access_token");
      axios__WEBPACK_IMPORTED_MODULE_7___default().get("/api/schedule/show/all", {
        headers: {
    ...
    filterSchedules: function filterSchedules() {
      ...
      filteredSchedules = filteredSchedules.filter(function (schedule) {
        return moment__WEBPACK_IMPORTED_MODULE_8___default()(schedule.tanggal).isSameOrAfter(moment__WEBPACK_IMPORTED_MODULE_8___default()(), 'day') && moment__WEBPACK_IMPORTED_MODULE_8___default()(schedule.tanggal).isSameOrAfter(moment__WEBPACK_IMPORTED_MODULE_8___default()(), 'hour');
      });

      if (this.selectedDate) {
        filteredSchedules = filteredSchedules.filter(function (schedule) {
          return moment__WEBPACK_IMPORTED_MODULE_8___default()(schedule.tanggal).format('YYYY-MM-DD') === moment__WEBPACK_IMPORTED_MODULE_8___default()(_this3.selectedDate).format('YYYY-MM-DD');
        });
      }
      ...
      if (this.selectedBrand) {
        var selectedBrandId = this.selectedBrand; // Directly use the selected brand id
    ...
    moment__WEBPACK_IMPORTED_MODULE_8___default().locale('id');
    return moment__WEBPACK_IMPORTED_MODULE_8___default()(date).format('dddd, Do MMMM YYYY, HH:mm:ss'); // Format jam menggunakan HH untuk 24 jam
  ...
  mounted: function mounted() {
    ...
    var access_token = localStorage.getItem("access_token");
    this.getSchedule();
    axios__WEBPACK_IMPORTED_MODULE_7___default().get("api/routes", {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
...
/***/ "./resources/js/src/assets/images/logos/tiket.png":
/*!********************************************************!*\
  !*** ./resources/js/src/assets/images/logos/tiket.png ***!
  \********************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("/images/tiket.png?5484ecd727a8d9b209971174fbfab753");
                ...
                [
                  ...
                  _c("v-card-title", { staticClass: "text-title" }, [
                    _c("h5", { staticClass: "white--text" }, [
                      _vm._v("Pelayanan terbaik untuk perjalananmu"),
                    ]),
                  ]),
                ],
                1
        ...
        [
          _c(
            ...
            [
                    ...
                    [
                      _c(
                        ...
                        [
                              ...
                              _vm._b(
                                {
                                  ...
                                  on: {
                                    click: function ($event) {
                                      _vm.showTypeInfo = !_vm.showTypeInfo
                                    },
                                  },
                                },
                                "v-icon",
                          ...
                          _vm._v(" "),
                          _c("span", [_vm._v("Keterangan tentang type")]),
                        ],
                        1
                      ),
                    ],
              ...
              _vm._v(" "),
              _vm.showTypeInfo && _vm.selectedType === "Eksekutif"
                ? _c(
                    "v-col",
                    [
                      _c(
                ...
                : _vm._e(),
              _vm._v(" "),
              _vm.showTypeInfo && _vm.selectedType === "Ekonomi"
                ? _c(
                    "v-col",
                    [
                      _c(
                      ...
                      [
                        _c(
                          ...
                          [
                            _c("img", {
                              attrs: {
                                src: (__webpack_require__(/*! @/assets/images/logos/tiket.png */ "./resources/js/src/assets/images/logos/tiket.png")["default"]),
                                "max-height": "50px",
                                "max-width": "100px",
                                alt: "avatar",
                              },
