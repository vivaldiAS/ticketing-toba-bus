...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_3___default().get("/api/Detail-keuangan-ByPassenger/".concat(this.schedule_id), {
      headers: {
