  ...
  methods: {
    ...
    BayarNontunai: function BayarNontunai() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().post('api/bookings/nontunai', {
        ...
        if (data.code === 200 && data.data.how_to_pay_page) {
          var xmlString = data.data.how_to_pay_page; // Buat instance DOMParser untuk mengurai XML

          var parser = new DOMParser();
          var xmlDoc = parser.parseFromString(xmlString, 'text/xml'); // Lakukan manipulasi sesuai kebutuhan Anda
          // Misalnya, jika Anda ingin mendapatkan konten teks dari elemen tertentu:

          var textContent = xmlDoc.querySelector('nama_elemen').textContent; // Gunakan variabel "textContent" untuk tindakan selanjutnya
