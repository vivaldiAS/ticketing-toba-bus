...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_6___default().get("/api/bookings/my", {
      ...
      var now = "".concat(year).concat(month).concat(day).concat(hours).concat(minutes).concat(seconds); // console.log(now);
      ...
      _this.pesanan.forEach(function (item) {
        ...
        if (now > expiredDate && item.status_pay !== "Expired") {
          ...
          console; // Mengirim permintaan ke API untuk memperbarui status pembayaran
