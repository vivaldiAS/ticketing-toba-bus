...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (0,D_Other_LARAVUE_APP_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])((0,D_Other_LARAVUE_APP_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({
    getColSize: function getColSize(n) {
      if (n <= 2) {
        return 6; // Lebar kolom untuk bagian depan (2 kursi)
      } else if (n <= 5) {
        return 4; // Lebar kolom untuk baris kedua (4 kursi)
      } else if (n <= 9) {
        return 4; // Lebar kolom untuk baris ketiga (4 kursi)
      } else if (n <= 12) {
        return 4; // Lebar kolom untuk baris keempat (4 kursi)
      } else {
    ...
    getDisplayedSeatNumber: function getDisplayedSeatNumber(n) {
      if (n === 2 || n === 6 || n === 9) {
        return ''; // Mengembalikan string kosong untuk kursi yang ingin dikosongkan
      } else {
                              ...
                              _c(
                                "div",
                                {
                                  class: [
                                    "pa- text-center text-no-wrap rounded",
                                    {
                                      style: _vm.selectedChair === n,
                                      booked: _vm.bookingsChair.some(function (
                                        chair
                                      ) {
                                        return chair.num_seats === n
                                      }),
                                    },
                                  ],
                                  on: {
                                ...
                                [
                                  ...
                                  _c("h4", [
                                    _vm._v(
                                      _vm._s(_vm.getDisplayedSeatNumber(n))
                                    ),
                                  ]),
                                ],
                                1
