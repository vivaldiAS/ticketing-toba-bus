...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    updatePassword: function updatePassword() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().post("/api/user/update-password", passwordData, {
        headers: {
          Authorization: "Bearer ".concat(access_token)
        }
      }).then(function (response) {
        ...
        _this3.passwordData.current_password = null;
        _this3.passwordData.new_password = null;
        _this3.passwordData.new_password_confirmation = null;
      })["catch"](function (error) {
