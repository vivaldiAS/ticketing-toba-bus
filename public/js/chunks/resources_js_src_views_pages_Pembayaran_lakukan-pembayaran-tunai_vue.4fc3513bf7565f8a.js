...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      // Mengubah schedule menjadi array daripada objek kosong
      schedule: []
    };
  },
  ...
  mounted: function mounted() {
    // Memanggil getSchedule() saat komponen dimuat
    this.getSchedule();
  },
  ...
  methods: {
    ...
    startCountdown: function startCountdown() {
      ...
      var bookingTime = moment__WEBPACK_IMPORTED_MODULE_3___default()();
      var departureTime = moment__WEBPACK_IMPORTED_MODULE_3___default()(this.item.tanggal);
      var maxCountdownTime = moment__WEBPACK_IMPORTED_MODULE_3___default().min(departureTime.subtract(1, "hours"), bookingTime.add(1, "hours"));
      ...
      this.countdownInterval = setInterval(function () {
        ...
        if (remainingTime <= 0) {
          ...
          _this2.updateCountdown(remainingTime);
        }
      }, 1000);
    },
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.custom-button[data-v-18381d06] {\r\n  width: 80%;\n}\n.loading-overlay[data-v-18381d06] {\r\n  position: fixed;\r\n  top: 0;\r\n  left: 0;\r\n  width: 100%;\r\n  height: 100%;\r\n  background-color: rgba(0, 0, 0, 0.5);\r\n  z-index: 9999;\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: center;\n}\n.loading-spinner[data-v-18381d06] {\r\n  border: 4px solid #f3f3f3;\r\n  border-top: 4px solid #3498db;\r\n  border-radius: 50%;\r\n  width: 40px;\r\n  height: 40px;\r\n  animation: spin-data-v-18381d06 2s linear infinite;\n}\n@keyframes spin-data-v-18381d06 {\n0% {\r\n    transform: rotate(0deg);\n}\n100% {\r\n    transform: rotate(360deg);\n}\n}\r\n", ""]);
// Exports
/* harmony default export */ __webpack_exports__["default"] = (___CSS_LOADER_EXPORT___);
  ...
  return _c(
    ...
    [
      _c(
        "v-card",
        [
          _c("v-card-title", [_vm._v("Lakukan Pembayaran ke Loket")]),
          _vm._v(" "),
          _c(
            "div",
            ...
            [
              _c("h2", [
                _vm._v(
                  _vm._s(_vm.item.derpature) + " -> " + _vm._s(_vm.item.arrival)
                ),
              ]),
              _vm._v(" "),
              _c("h5", [_vm._v(_vm._s(_vm.formatHour(_vm.item.tanggal)))]),
              _vm._v(" "),
              _c("h5", [_vm._v(_vm._s(_vm.formatDate(_vm.item.tanggal)))]),
              _vm._v(" "),
              _c("h5", [
                _vm._v(
                  _vm._s(
                    _vm._f("toRupiah")(_vm.item.harga * _vm.selectedSeat.length)
                  )
                ),
              ]),
              _vm._v(" "),
