  ...
  methods: {
    ...
    submitData: function submitData() {
      ...
      if (!isNaN(this.totalHarga) && this.totalHarga !== null) {
        console.log('Nilai selectedSeat sebelum komitasi(halaman costum_pesanan.vue):', this.selectedSeat);
        this.$store.commit('SET_SELECTED_SEATS', this.selectedSeat.slice());
        console.log('Nilai selectedSeat setelah komitasi(halaman costum_pesanan.vue):', this.selectedSeat);
