    ...
    BayarNontunai: function BayarNontunai() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().post('api/bookings/nontunai', {
        ...
        if (data.code === 200 && data.data.virtual_account_info.how_to_pay_api) {
          ...
          var domDocument = domParser.parseFromString(data.data.virtual_account_info.how_to_pay_api, 'text/xml');
          var xmlAsString = domDocument.textContent;
          var xmlNode = document.createElement('xml');
          xmlNode.innerHTML = xmlAsString;
          var xmlSerializer = new XMLSerializer();
          xmlSerializer.xmlVersion = "1.0";
          xmlSerializer.preserveWhitespace = false;
          var jsonString = xmlSerializer.serializeToString(xmlNode);
          console.log(jsonString);
          var div = document.getElementById('myDiv');

          if (div) {
            div.insertAdjacentHTML('beforeend', jsonString);
          } else {
