    ...
    BayarNontunai: function BayarNontunai() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().post('api/bookings/nontunai', {
        ...
        if (data.code === 200 && data.data.virtual_account_info.how_to_pay_api) {
          ...
          var xmlDoc = parser.parseFromString(xmlString, 'text/xml'); // Konversi XML menjadi JSON
        ...
        return _c("v-card", { key: item.id }, [
          _c(
            ...
            [
              ...
              _vm._v(" "),
              _c("div", { attrs: { id: "xml" } }, [
                _c("h4", [_vm._v("Isi dari XML:")]),
                _vm._v(" "),
                _c("p", [_vm._v("Nama Elemen 1: " + _vm._s(_vm.namaElemen1))]),
                _vm._v(" "),
                _c("p", [_vm._v("Nama Elemen 2: " + _vm._s(_vm.namaElemen2))]),
              ]),
            ],
            2
          ),
