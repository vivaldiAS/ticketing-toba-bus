...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    ...
    var errors = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__.ref)({});
    ...
    var busOptions = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__.ref)([]);
    var routeOptions = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__.ref)([]);
    var dayOptions = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__.ref)([{
      text: 'Minggu',
      value: 0
    }, {
      text: 'Senin',
    ...
    var fetchScheduleById = /*#__PURE__*/function () {
      var _ref3 = (0,E_laragon_www_DantobBuss_Application_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee3(id) {
        var access_token, response, schedule;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.prev = 1;
                _context3.next = 4;
                return axios__WEBPACK_IMPORTED_MODULE_7___default().get("/api/default-schedules/".concat(id), {
                  headers: {
                    Authorization: "Bearer ".concat(access_token)
                  }
                });
              ...
              case 4:
                ...
                data.value.bus = schedule.bus_id;
                data.value.route = schedule.route_id;
                data.value.day = schedule.day_of_week;
                data.value.time = schedule.time;
                data.value.harga = schedule.harga;
                _context3.next = 16;
                break;
      ...
      return function fetchScheduleById(_x) {
            ...
            switch (_context4.prev = _context4.next) {
              ...
              case 9:
                ...
                if (_context4.t0.response.status === 422) {
                  errors.value = _context4.t0.response.data.data;
                }
    ...
    (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__.onMounted)(function () {
      fetchBusOptions();
      fetchRouteOptions();
    }); // Watch for changes in route.params.id

    (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__.watchEffect)(function () {
...
var render = function () {
  ...
  return _c(
    ...
    { staticClass: "ml-3" },
    [
      _c("v-card-title", [_vm._v("RUD Jadwal")]),
      _vm._v(" "),
      _c(
        "v-card-text",
        [
