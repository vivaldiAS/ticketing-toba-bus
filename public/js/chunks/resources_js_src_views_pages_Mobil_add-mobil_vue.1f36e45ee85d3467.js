...
/* harmony default export */ __webpack_exports__["default"] = ({
  setup: function setup() {
    ...
    var mobil = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_5__.ref)({
      police_number: "",
      nomor_pintu: "",
      type: "",
      driver: null,
    ...
    var supir = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_5__.ref)([]);
    var loket = (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_5__.ref)([]);

    var AddMobil = function AddMobil() {
      var access_token = localStorage.getItem("access_token");
      axios__WEBPACK_IMPORTED_MODULE_4___default().post("/api/buss/add", {
        police_number: mobil.value.police_number,
        type: mobil.value.type,
        supir_id: mobil.value.driver,
        number_of_seats: mobil.value.number_of_seats,
        nomor_pintu: mobil.value.nomor_pintu,
        merk: "KBT",
        loket_id: mobil.value.loket
      }, {
        headers: {
    ...
    var saveSelectedItemId = function saveSelectedItemId() {// Simpan selectedItem.id ke database di sini
      // console.log('Selected item id:', mobil.value.driver);
    };

    var loadSupir = function loadSupir() {
      var access_token = localStorage.getItem("access_token");
      axios__WEBPACK_IMPORTED_MODULE_4___default().get("/api/supir/name/all", {
        headers: {
          Authorization: "Bearer ".concat(access_token)
        }
      }).then(function (response) {
        supir.value = response.data.filter(function (item) {
        ...
        console.log("supir", supir.value);
      })["catch"](function (error) {
        console.log(error);
      });
    };

    var loadLoket = function loadLoket() {
      var access_token = localStorage.getItem("access_token");
      axios__WEBPACK_IMPORTED_MODULE_4___default().get("/api/loket/all", {
        ...
        loket.value = response.data.filter(function (item) {
          return item.status === 1;
        }).map(function (item) {
          return {
    ...
    return {
      ...
      loket: loket,
      AddMobil: AddMobil,
      saveSelectedItemId: saveSelectedItemId
    };
  }
});
              ...
              _c(
                ...
                [
                  _c("v-col", { attrs: { cols: "12", md: "3" } }, [
                    _c("label", { attrs: { for: "police_number" } }, [
                      _vm._v("Nomor Polisi"),
                    ]),
                  ]),
                  _vm._v(" "),
                  ...
                  _vm._v(" "),
                  _c("v-col", { attrs: { cols: "12", md: "3" } }, [
                    _c("label", { attrs: { for: "nomor_pintu" } }, [
                      _vm._v("Nomor Pintu"),
                    ]),
                  ]),
                  _vm._v(" "),
                  ...
                  _vm._v(" "),
                  _c("v-col", { attrs: { cols: "12", md: "3" } }, [
                    _c("label", { attrs: { for: "loket" } }, [_vm._v("Loket")]),
                  ]),
                  _vm._v(" "),
                  _c(
                    "v-col",
                  ...
                  _vm._v(" "),
                  _c("v-col", { attrs: { cols: "12", md: "3" } }, [
                    _c("label", { attrs: { for: "number_of_seats" } }, [
                      _vm._v("Jumlah Seats"),
                    ]),
                  ]),
                  _vm._v(" "),
                  _c(
                    ...
                    [
                      _c("v-text-field", {
                        attrs: {
                          type:
                            _vm.mobil.type === "Eksekutif"
                              ? "number"
                              : "number",
                          max: _vm.mobil.type === "Eksekutif" ? 14 : 12,
                          outlined: "",
                          dense: "",
