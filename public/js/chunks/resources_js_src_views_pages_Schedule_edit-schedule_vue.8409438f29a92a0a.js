...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_5___default().get("/api/schedule/show/".concat(id), {
      ...
      console.log(_this.schedule); // this.schedule.bus_id = response.data.data[0].bus_id;

      var selectedBus = _this.bus.find(function (bus) {
        return bus.id === _this.schedule.bus_id;
      });

      if (selectedBus) {
        _this.selectedBusType = selectedBus.type;
      } // console.log("data", );
