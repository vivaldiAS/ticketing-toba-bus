    ...
    BayarNontunai: function BayarNontunai() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().post('api/bookings/nontunai', {
        ...
        if (data.code === 200 && data.data.virtual_account_info.how_to_pay_api) {
          ...
          axios__WEBPACK_IMPORTED_MODULE_2___default().get(howToPayApi, {
            headers: {
              'Authorization': "Bearer ".concat(access_token)
            }
          }).then(function (response) {
            _this4.howtoPayStep = response.data.data;
            console.log(_this4.howtoPayStep);
          });
          console.log(howtoPayStep); // console.log(data.data.virtual_account_info.how_to_pay_api)
        } else {
