          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.prev = 1;
                _context4.next = 4;
                return axios__WEBPACK_IMPORTED_MODULE_7___default().get("/api/default-schedules/".concat(route.params.id), {
                  headers: {
                    Authorization: "Bearer ".concat(access_token)
                  }
                });
              ...
              case 4:
                ...
                data.value = {
                  bus: response.data.bus_id,
                  route: response.data.route_id,
