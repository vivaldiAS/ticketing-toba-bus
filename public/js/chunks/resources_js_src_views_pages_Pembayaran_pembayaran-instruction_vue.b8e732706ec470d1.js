...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().get(this.$route.query.howToPayApi, {
      headers: {
        'Authorization': "Bearer ".concat(access_token)
      }
    }).then(function (response) {
      _this.paymentInstructions = response.data.payment_instruction;
    });
  }
});
...
var render = function () {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _vm._l(_vm.paymentInstructions, function (instruction) {
