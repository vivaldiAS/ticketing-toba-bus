...
/* harmony import */ var _var_www_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/objectSpread2 */ "./node_modules/@babel/runtime/helpers/esm/objectSpread2.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {},
  methods: (0,_var_www_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])((0,_var_www_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({}, (0,vuex__WEBPACK_IMPORTED_MODULE_7__.mapActions)(["setSelectedSeat"])), {}, {
    ...
    countBookingsExe: function countBookingsExe(bookings) {
      var countsExe = {};
      bookings.forEach(function (booking) {
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_3___default().get("/api/schedule/type/economi", {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
      _this.economi = response.data.data;
      _this.bookingCounts = _this.countBookings(response.data.total);
    })["catch"](function (error) {
      console.log(error);
    });
    axios__WEBPACK_IMPORTED_MODULE_3___default().get("/api/schedule/type/executive", {
      headers: {
        Authorization: "Bearer ".concat(access_token)
      }
    }).then(function (response) {
      _this.executive = response.data.data;
      _this.bookingCountsExe = _this.countBookingsExe(response.data.total);
    })["catch"](function (error) {
      console.log(error);
    });
  }
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          _c("v-tab", { attrs: { color: "primary" } }, [_vm._v(" Ekonomi ")]),
          _vm._v(" "),
          _c("v-tab", [_vm._v(" Eksekutif ")]),
        ],
        1
      ),
      _vm._v(" "),
          ...
          _c(
            ...
            [
              _c(
                "v-card",
                { attrs: { flat: "" } },
                _vm._l(_vm.economi, function (eco) {
                  return _c(
                    "v-card",
                    { key: eco.schedule_id, staticClass: "mb-2" },
                    [
                      _c(
                        "v-row",
                        { attrs: { "no-gutters": "" } },
                            ...
                            [
                              _c(
                                ...
                                [
                                  _c("img", {
                                    attrs: {
                                      src: Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/assets/images/logos/logo-KBT.png'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
                                      "max-height": "50px",
                                      "max-width": "100px",
                                      alt: "avatar",
                                    },
                          ...
                          _c(
                            ...
                            [
                              ...
                              _c(
                                ...
                                [
                                  _c("h6", [_vm._v(_vm._s(eco.nomor_pintu))]),
                                  _vm._v(" "),
                                  _c(
                                    "h6",
                                    { staticClass: "text--primary ml-5" },
                                    [_vm._v(_vm._s(eco.type))]
                                  ),
                                ]
                              ),
                              _vm._v(" "),
                                    ...
                                    [
                                      _c(
                                        ...
                                        [
                                          ...
                                          !Object.keys(
                                            _vm.bookingCounts
                                          ).includes(String(eco.schedule_id))
                                            ? _c(
                                                "div",
                                                { staticClass: "col-md-2" },
                                                [
          ...
          _c(
            ...
            [
              _c(
                "v-card",
                { attrs: { flat: "" } },
                _vm._l(_vm.executive, function (exe) {
                  return _c(
                    "v-card",
                    { key: exe.schedule_id, staticClass: "mb-2" },
                    [
                      _c(
                        "v-row",
                        { attrs: { "no-gutters": "" } },
                          ...
                          _c(
                            ...
                            [
                              ...
                              _c(
                                ...
                                [
                                  _c("h6", [_vm._v(_vm._s(exe.nomor_pintu))]),
                                  _vm._v(" "),
                                  _c(
                                    "h6",
                                    { staticClass: "text--primary ml-5" },
                                    [_vm._v(_vm._s(exe.type))]
                                  ),
                                ]
                              ),
                              _vm._v(" "),
                                    ...
                                    [
                                      _c(
                                        ...
                                        [
                                          ...
                                          _vm._v(" "),
                                          _vm._l(
                                            _vm.bookingCountsExe,
                                            function (count, id) {
                                              return exe.schedule_id == id
                                                ? _c(
                                                    "div",
                                                    {
                                                      key: id,
                                          ...
                                          !Object.keys(
                                            _vm.bookingCountsExe
                                          ).includes(String(exe.schedule_id))
                                            ? _c(
                                                "div",
                                                { staticClass: "col-md-2" },
                                                [
